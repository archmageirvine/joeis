...
export JUMBLE_OPTS="-r -i -j -k -w -S -x main -d javax.imageio.ImageIO"
...
export LEVEL=4
export STYLE_EXCLUDES="Beta.java LineOfSight.java GrammarParser.java GrammarLexer.java GrammarListener.java GrammarBaseListener.java"
