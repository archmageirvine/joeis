...
//    }
   ...
   * @param tv the vertex fixed to get the first child = the smallest-numbered vertex in the target cell
   ...
   * @param numOrbits the number of orbits of the group generated by all the automorphisms so far discovered
   * @param numCells = the total number of cells in the equitable partition at this level
