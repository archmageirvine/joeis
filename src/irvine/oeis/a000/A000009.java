...
/**
 * A000009 Expansion of <code>Product_{m &gt;= 1} (1 + x^m)</code>; number of partitions of n into distinct parts; number of partitions of n into odd parts (if <code>n &gt; 0)</code>.
