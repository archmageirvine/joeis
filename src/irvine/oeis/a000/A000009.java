...
/**
 * A000009 Expansion of Product_{m <code>&gt;= 1} (1 +</code> x^m); number of partitions of n into distinct parts; number of partitions of n into odd parts (if <code>n &gt; 0)</code>.
