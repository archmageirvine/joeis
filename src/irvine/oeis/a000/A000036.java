...
/**
 * A000036 Let A(n) = #{(i,j): i^2 + j^2 <code>&lt;= n},</code> V(n) = Pi*n, P(n) = A(n) - V(n); A000099 gives values of n where |P(n)| sets a new record; sequence gives closest integer to P(A000099(n)).
