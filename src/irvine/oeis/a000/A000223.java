...
/**
 * A000223 Let <code>A(n) = #{(i,j,k)</code>: <code>i^2 + j^2 + k^2 &lt;= n}, V(n) =</code> (4/3)Pi*n^(3/2), <code>P(n) = A(n) - V(n)</code>; A000092 gives values of n where <code>|P(n)|</code> sets a new record; sequence gives (nearest integer to, I believe) P(A000092(n)).
