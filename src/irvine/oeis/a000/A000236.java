...
/**
 * A000236 Maximum m such that there are no two adjacent elements belonging to the same n-th power residue class modulo some prime p in the sequence <code>1,2,...,m (equivalently</code>, there is no n-th power residue modulo p in the sequence <code>1/2,2/3,...,(m-1)/m)</code>.
