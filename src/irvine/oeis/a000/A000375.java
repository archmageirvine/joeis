...
/**
 * A000375 Topswops <code>(1)</code>: start by shuffling n cards labeled 1..n. If top card is m, reverse order of top m cards, then repeat. <code>a(n)</code> is the maximal number of steps before top card is 1.
