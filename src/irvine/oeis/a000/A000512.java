...
/**
 * A000512 Number of equivalence classes of n X n matrices over <code>{0,1}</code> with rows and columns summing to 3, where equivalence is defined by row and column permutations.
