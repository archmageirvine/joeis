...
/**
 * A000847 Number of <code>n-input 2-output</code> switching networks under action of <code>GL(n,2)</code> on the inputs and complementing group <code>C(2,2)</code> on the outputs.
