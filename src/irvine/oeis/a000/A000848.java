...
/**
 * A000848 Number of n-input 3-output switching networks under action of <code>GL(n,2)</code> on the inputs and complementing group <code>C(3,2)</code> on the outputs.
