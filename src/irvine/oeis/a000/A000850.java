...
/**
 * A000850 Number of n-input 2-output switching networks under action of <code>AG(n,2)</code> on the inputs and complementing group <code>C(2,2)</code> on the outputs.
