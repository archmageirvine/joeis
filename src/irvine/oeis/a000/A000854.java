...
/**
 * A000854 Number of n-input 3-output switching networks under action of complementing group <code>C(2,n)</code> on inputs and <code>S(3)</code> and <code>C(2,3)</code> on outputs.
