...
/**
 * A000860 Number of <code>n-input 3-output</code> switching networks under action of <code>S(n)</code> and complementing group <code>C(2,3)</code> on inputs and outputs.
