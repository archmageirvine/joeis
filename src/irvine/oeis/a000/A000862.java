...
/**
 * A000862 Number of <code>n-input 2-output</code> switching networks under action of <code>AG(n,2)</code> and complementing group <code>C(2,2)</code> on inputs and outputs.
