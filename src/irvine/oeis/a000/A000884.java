...
/**
 * A000884 Number of switching networks with <code>C(2,n)</code> acting on the domain and <code>AG(3,2)</code> acting on the domain.
 * @author Sean A. Irvine
 */
public class A000884 implements Sequence {
