...
/**
 * A001150 Number of <code>n-input 2-output</code> switching networks with <code>GL(n,2)</code> acting on the input and <code>S(2)</code> and <code>C(2,2)</code> acting on the output.
