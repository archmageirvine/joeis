...
/**
 * A001152 Number of n-input 3-output switching networks with <code>GL(n,2)</code> acting on the input and <code>S(3)</code> and <code>C(2,3)</code> acting on the output.
