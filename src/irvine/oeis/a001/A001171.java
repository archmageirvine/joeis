...
/**
 * A001171 From least significant term in expansion of <code>E(</code> tr <code>(X'*X)^n )</code>, X rectangular and Gaussian. Also number of types of sequential n-swap moves for traveling salesman problem.
