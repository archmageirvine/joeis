...
/**
 * A001293 Leech triangle: k-th number (0&lt;=k&lt;=n) in n-th row <code>(0&lt;=n)</code> is number of octads in S(5,8,24) containing k given points and missing n-k given points.
