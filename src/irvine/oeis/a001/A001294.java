...
/**
 * A001294 Triangle in which k-th number <code>(0&lt;=k&lt;=n)</code> in n-th row <code>(0&lt;=n)</code> is number of dodecads in Golay code G_24 containing k given points and missing <code>n-k</code> given points.
