...
/**
 * A001294 Triangle in which k-th number (0&lt;=k&lt;=n) in n-th row <code>(0&lt;=n)</code> is number of dodecads in Golay code G_24 containing k given points and missing n-k given points.
