...
/**
 * A001990 Let p be the n-th odd prime. <code>a(n)</code> is the least prime congruent to 5 modulo 8 such that Legendre(-a(n), q) = -Legendre(-2, q) for all odd primes q <code>&lt;=</code> p.
