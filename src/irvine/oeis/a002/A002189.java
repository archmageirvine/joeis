...
/**
 * A002189 Pseudo-squares: <code>a(n) =</code> the least nonsquare positive integer which is <code>1 mod 8</code> and is a (nonzero) quadratic residue modulo the first n odd primes.
