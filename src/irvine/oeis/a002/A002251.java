...
/**
 * A002251 Start with sequence of nonnegative integers; then swap <code>L(k)</code> and <code>U(k)</code> for all k <code>&gt;= 1</code>, where L <code>= A000201, U = A001950 (lower</code> and upper Wythoff sequences).
