...
/**
 * A002322 Reduced totient function psi(n): least k such that x^k <code>== 1 (mod n)</code> for all x prime to n; also known as the Carmichael lambda function (exponent of unit group <code>mod n)</code>; also called the universal exponent of n.
