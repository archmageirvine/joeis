...
/**
 * A002350 Take solution to Pellian equation <code>x^2 - n*y^2 = 1</code> with smallest positive y and <code>x &gt;= 0</code>; sequence gives <code>a(n) = x</code>, or 1 if n is a square. A002349 gives values of y.
