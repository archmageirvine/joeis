...
public class A002410 implements Sequence {
  ...
  private static final CR C2A = TAU4.multiply(CR.valueOf(18)).inverse();
  private static final CR C2B = TAU2.multiply(CR.FOUR).inverse();
  private static final CR C3A = TAU6.multiply(CR.valueOf(162)).inverse();
  private static final CR C3B = TAU4.multiply(CR.valueOf(new Q(15, 2))).inverse();
  private static final CR C3C = TAU2.multiply(CR.valueOf(8)).inverse();
  private static final CR C4A = TAU8.multiply(CR.valueOf(1944)).inverse(); // 2^3 * 3^5
  ...
  private static final CR C4D = TAU2.multiply(CR.valueOf(32)).inverse();
  private static final CR C5A = TAU10.multiply(CR.valueOf(29160)).inverse(); // 2^3 * 3^6 * 5
  ...
  private static final CR C6A = TAU12.multiply(CR.valueOf(524880)).inverse();
