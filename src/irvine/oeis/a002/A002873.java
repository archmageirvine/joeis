...
/**
 * A002873 The maximal number of partitions of <code>{1</code>..2n} that are invariant under a permutation consisting of n 2-cycles, and which have the same number of nonempty parts.
