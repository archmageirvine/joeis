...
/**
 * A002968 Number of pairings <code>{(b[1]</code>,c[1]),(b[2],c[2]),...,(b[n],c[n])} of the first <code>2n</code> positive integers satisfying b[i] &lt; c[i] and such that the <code>2n</code> numbers c[i]+b[i] and c[i]-b[i] are all distinct.
