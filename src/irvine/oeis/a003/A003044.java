...
/**
 * A003044 For <code>n &gt; 4, a(n)</code> is the least integer <code>&gt; a(n-1)</code> with precisely two representations <code>a(n) = a(i) + a(j), 1 &lt;= i &lt; j &lt</code>; n; and <code>a(n) = n</code> for <code>n=1..4</code>.
