...
/**
 * A003050 Number of primitive sublattices of index n in hexagonal lattice: triples x,y,z from <code>Z/nZ</code> with <code>x+y+z = 0</code>, discarding any triple that can be obtained from another by multiplying by a unit and permuting.
