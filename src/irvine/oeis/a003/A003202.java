 ...
 */
public class A003202 extends Sequence0 {
  ...
  public Z next() {
    if (++mN > 0) {
      mPerimeterCounts = new long[2 * mN + 5];
      final Hunter h = new Hunter(Lattices.HEXAGONAL, true) {
        {
          setKeeper((animal, forbidden) -> ++mPerimeterCounts[animal.perimeterSize(Lattices.HEXAGONAL)]);
        }
      };
      h.count(mN);
