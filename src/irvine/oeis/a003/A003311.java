...
/**
 * A003311 Write down the numbers from 3 to infinity. Take next number, M say, that has not been crossed off. Counting through the numbers that have not yet been crossed off after that M, cross off the first, <code>(M+1)st, (2M+1)st, (3M+1)st.</code>, etc. Repeat. The numbers that are left form the sequence.
