...
/**
 * A003842 The infinite Fibonacci word: start with <code>1,</code> repeatedly apply the morphism <code>1-&gt;12, 2-&gt;1,</code> take limit; or, start with S(0)=2, S(1)=1, and for <code>n&gt;1</code> define S(n)=S(n-1)S(n-2), then the sequence is S(oo).
