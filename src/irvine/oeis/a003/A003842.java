...
/**
 * A003842 The infinite Fibonacci word: start with 1, repeatedly apply the morphism <code>1-&gt;12, 2-&gt;1</code>, take limit; or, start with <code>S(0)=2, S(1)=1</code>, and for <code>n&gt;1</code> define <code>S(n)=S(n-1)S(n-2)</code>, then the sequence is S(oo).
