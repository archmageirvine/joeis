...
/**
 * A004065 Define predecessors of <code>n,</code> P(n), to consist of numbers whose binary representation is obtained from that of n by replacing 10 with 01 or changing a final 1 to <code>a 0</code>; then <code>a(0)=1, a(n) =</code> Sum a(P(n)), <code>n&gt;0</code>.
