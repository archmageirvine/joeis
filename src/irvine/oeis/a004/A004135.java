...
/**
 * A004135 Additive bases: <code>a(n)</code> is the least integer k such that in the cyclic group <code>Z_k</code> there is a subset of n elements all pairs (of distinct elements) of which add up to a different sum <code>(in Z_k)</code>.
