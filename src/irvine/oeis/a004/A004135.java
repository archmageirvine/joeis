...
/**
 * A004135 Additive bases: <code>a(n)</code> is the least integer k such that in the cyclic group Z_k there is a subset of n elements all pairs (of distinct elements) of which add up to a different sum <code>(in</code> Z_k).
