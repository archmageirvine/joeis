...
/**
 * A004394 Superabundant [or super-abundant] numbers: n such that <code>sigma(n)/n &gt</code>; sigma(m)/m for all m <code>&lt; n, sigma(n)</code> being A000203(n), the sum of the divisors of n.
