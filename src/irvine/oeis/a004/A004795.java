...
/**
 * A004795 Least positive unitary linear combination of distinct numbers in row n of Pascal's triangle; i.e., least positive sum of form d(0)C(n-1,0) + d(1)C(n-1,1) <code>+ ...+</code> d(m)C(n-1,m), d(i)=+-1, m <code>= floor((n+1)/2)</code>.
