...
/**
 * A005198 <code>a(n)</code> is the number of forests with <code>n (unlabeled)</code> nodes in which each component tree is planted, that is, is a rooted tree in which the root has degree 1.
