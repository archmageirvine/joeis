...
/**
 * A005729 a(n) is the smallest positive integer a for which there is an identity of the form a*x = Sum_{i=1..m} ai*gi(x)^n where a1, ..., am are in Z and g1(x), ..., gm(x) are in Z[x].
