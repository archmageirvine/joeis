...
/**
 * A005729 <code>a(n)</code> is the smallest positive integer a for which there is an identity of the form <code>a*x = Sum_{i=1..m} ai*gi(x)^n</code> where <code>a1</code>, ..., am are in Z and <code>g1(x)</code>, ..., <code>gm(x)</code> are in <code>Z[x]</code>.
