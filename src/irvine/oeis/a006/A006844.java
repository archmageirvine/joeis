...
/**
 * A006844 <code>a(1)=4, a(2)=5</code>; thereafter <code>a(n)</code> is smallest number that is greater than <code>a(n-1)</code> and having a unique representation as a(j) + a(k) for j&lt;k.
