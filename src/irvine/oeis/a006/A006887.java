...
/**
 * A006887 Kaprekar triples: q such that q <code>= x +</code> y + z and q^3 <code>= x*10^2n +</code> y*10^n + z, where z <code>&lt; 10^n</code> and n is the number of digits in q. q is not a power of 10 (except q=1).
