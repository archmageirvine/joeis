...
/**
 * A006887 Kaprekar triples: q such that q <code>= x + y + z</code> and <code>q^3 = x*10^2n + y*10^n +</code> z, where <code>z &lt; 10^n</code> and n is the number of digits in q. q is not a power of <code>10 (except q=1)</code>.
