...
/**
 * A006887 Kaprekar triples: q such that q <code>= x + y + z</code> and q^3 <code>= x*10^2n + y*10^n + z,</code> where <code>z &lt; 10^n</code> and n is the number of digits in q. q is not a power of 10 (except q=1).
