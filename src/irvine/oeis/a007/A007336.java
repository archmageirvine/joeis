...
/**
 * A007336 Signature sequence of <code>sqrt 2 (arrange</code> the numbers <code>i+j*x (i,j &gt;= 1)</code> in increasing order; the sequence of i's is the signature of <code>x)</code>.
