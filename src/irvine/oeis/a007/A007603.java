...
/**
 * A007603 Power-sum numbers: let <code>n = a_1 a_2 ... a_k</code> be a k-digit number; n is a power-sum number if there are exponents <code>e_1 ... e_m</code> such that <code>n = Sum_{i=1..m} Sum_{j=1..k} a_j^e_i</code>.
