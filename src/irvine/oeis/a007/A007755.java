...
/**
 * A007755 Smallest number m such that the trajectory of m under iteration of Euler's totient function <code>phi(n)</code> [A000010] contains exactly n distinct numbers, including m and the fixed point.
