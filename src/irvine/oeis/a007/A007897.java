...
/**
 * A007897 <code>a(n)</code> is multiplicative with <code>a(2) = 1; a(4) = 2; a(2^i) = 2^(i-2)+2</code> if <code>i&gt;2; a(p^i) = 1+(p-1)*p^(i-1)/2</code> if prime <code>p&gt;2</code> and <code>i&gt;0</code>.
