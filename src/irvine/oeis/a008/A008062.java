...
/**
 * A008062 <code>a(n) =</code> maximal value of m such that an n X m radar array exists. (A <code>(0,1)</code> matrix A such that <code>any</code> horizontal shift of A overlaps A in at most a single 1.).
