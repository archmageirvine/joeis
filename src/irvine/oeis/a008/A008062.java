...
/**
 * A008062 <code>a(n) =</code> maximal value of m such that <code>an n</code> X m radar array exists. (A <code>(0,1)</code> matrix A such that any horizontal shift of A overlaps A in at most a single 1.).
