...
/**
 * A008304 Triangle read by rows: T(n,k) <code>(n&gt;=1</code>; <code>1&lt;=k&lt;=n)</code> is the number of permutations of <code>[n]</code> in which the longest increasing run has length k.
