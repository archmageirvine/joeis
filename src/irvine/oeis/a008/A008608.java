...
/**
 * A008608 Number of <code>n X n</code> upper triangular matrices A of nonnegative integers such that <code>a_1i + a_2i +</code> ... <code>+ a_{i-1,i} - a_ii - a_{i,i+1} -</code> ... <code>- a_in = -1</code>.
