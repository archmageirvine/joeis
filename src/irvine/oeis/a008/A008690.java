...
/**
 * A008690 Theta series of Niemeier lattice of type <code>D_12^2</code>.
 * @author Sean A. Irvine
 */
public class A008690 implements Sequence {
  ...
  public Z next() {
    ...
    return e4.coeff(mN).multiply(8).add(e6.coeff(mN)).divide(9);
  }
}
