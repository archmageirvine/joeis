...
/**
 * A008691 Theta series of Niemeier lattice of type <code>A_17 E_7</code>.
 * @author Sean A. Irvine
 */
public class A008691 implements Sequence {
  ...
  public Z next() {
    ...
    return e4.coeff(mN).multiply(5).add(e6.coeff(mN)).divide(6);
  }
}
