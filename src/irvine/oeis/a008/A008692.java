...
/**
 * A008692 Theta series of Niemeier lattice of type <code>A_15 D_9</code>.
 * @author Sean A. Irvine
 */
public class A008692 implements Sequence {
  ...
  public Z next() {
    ...
    return e4.coeff(mN).multiply(29).add(e6.coeff(mN).multiply(7)).divide(36);
  }
}
