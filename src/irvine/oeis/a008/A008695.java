...
/**
 * A008695 Theta series of Niemeier lattice of type <code>A_11 D_7 E_6</code>.
 * @author Sean A. Irvine
 */
public class A008695 implements Sequence {
  ...
  public Z next() {
    ...
    return e4.coeff(mN).multiply(3).add(e6.coeff(mN)).divide(4);
  }
}
