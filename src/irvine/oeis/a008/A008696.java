...
/**
 * A008696 Theta series of Niemeier lattice of type <code>D_6^4</code>.
 * @author Sean A. Irvine
 */
public class A008696 implements Sequence {
  ...
  public Z next() {
    ...
    return e4.coeff(mN).multiply(13).add(e6.coeff(mN).multiply(5)).divide(18);
  }
}
