...
/**
 * A008697 Theta series of Niemeier lattice of type <code>A_8^3</code>.
 * @author Sean A. Irvine
 */
public class A008697 implements Sequence {
  ...
  public Z next() {
    ...
    return e4.coeff(mN).multiply(17).add(e6.coeff(mN).multiply(7)).divide(24);
  }
}
