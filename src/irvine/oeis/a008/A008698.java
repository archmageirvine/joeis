...
/**
 * A008698 Theta series of Niemeier lattice of type <code>A_7^2 D_5^2</code>.
 * @author Sean A. Irvine
 */
public class A008698 implements Sequence {
  ...
  public Z next() {
    ...
    return e4.coeff(mN).multiply(25).add(e6.coeff(mN).multiply(11)).divide(36);
  }
}
