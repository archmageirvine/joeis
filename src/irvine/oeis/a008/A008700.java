...
/**
 * A008700 Theta series of Niemeier lattice of type <code>D_4^6</code>.
 * @author Sean A. Irvine
 */
public class A008700 implements Sequence {
  ...
  public Z next() {
    ...
    return e4.coeff(mN).multiply(2).add(e6.coeff(mN)).divide(3);
  }
}
