...
/**
 * A008702 Theta series of Niemeier lattice of type <code>A_3^8</code>.
 * @author Sean A. Irvine
 */
public class A008702 implements Sequence {
  ...
  public Z next() {
    ...
    return e4.coeff(mN).multiply(23).add(e6.coeff(mN).multiply(13)).divide(36);
  }
}
