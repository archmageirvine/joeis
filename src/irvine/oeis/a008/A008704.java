...
/**
 * A008704 Theta series of Niemeier lattice of type <code>A_1^24</code>.
 * @author Sean A. Irvine
 */
public class A008704 implements Sequence {
  ...
  public Z next() {
    ...
    return e4.coeff(mN).multiply(11).add(e6.coeff(mN).multiply(7)).divide(18);
  }
}
