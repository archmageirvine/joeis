...
/**
 * A008781 For any circular arrangement of <code>0..n-1</code>, let S be the sum of cubes of every sum of two contiguous numbers; then <code>a(n)</code> is the number of distinct values of S.
