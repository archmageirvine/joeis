...
/**
 * A008970 Triangle T(n,k) = P(n,k)/2, <code>n &gt;= 2,</code> 1&lt;=k&lt;n, of one-half of number of permutations of 1..n such that the differences have k runs with the same signs.
