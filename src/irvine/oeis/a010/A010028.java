...
/**
 * A010028 Triangle read by rows: <code>T(n,k) = one-half</code> the number of permutations of length n with exactly n-k rising or falling successions, for <code>n &gt;= 1, 1 &lt;= k &lt;= n. T(1,1) = 1</code> by convention.
