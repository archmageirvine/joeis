...
/**
 * A010029 Irregular triangle read by rows: T(n,k) <code>(n&gt;=1, 0 &lt;=</code> k <code>&lt;= floor(n/2)) =</code> number of permutations of 1..n with exactly <code>floor(n/2) -</code> k runs of consecutive pairs up.
