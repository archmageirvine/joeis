...
/**
 * A010029 Irregular triangle read by rows: <code>T(n,k) (n&gt;=1, 0 &lt;= k &lt;= floor(n/2)) =</code> number of permutations of <code>1..n</code> with exactly <code>floor(n/2) - k</code> runs of consecutive pairs up.
