...
/**
 * A010030 Irregular triangle read by rows: T(n,k) <code>(n &gt;= 1, 0 &lt;= k &lt;= [n/2]) = </code> number of permutations of <code>1..n</code> with <code>[n/2]-k</code> runs of consecutive pairs up and down (divided by 2).
