...
/**
 * A010030 Irregular triangle read by rows: T(n,k) <code>(n &gt;= 1, 0 &lt;=</code> k <code>&lt;= [n/2]) = </code> number of permutations of 1..n with [n/2]-k runs of consecutive pairs up and down (divided by <code>2)</code>.
