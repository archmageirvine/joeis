...
/**
 * A010372 Number of unrooted quartic trees with n (unlabeled) nodes and possessing a centroid; number of n-carbon alkanes <code>C(n)H(2n +2)</code> with a centroid ignoring stereoisomers.
