...
/**
 * A010372 Number of unrooted quartic trees with n (unlabeled) nodes and possessing a centroid; number of n-carbon alkanes C(n)H(2n <code>+2)</code> with a centroid ignoring stereoisomers.
