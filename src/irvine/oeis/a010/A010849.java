...
/**
 * A010849 Let <code>S(x,y) =</code> number of lattice paths from <code>(0,0)</code> to <code>(x,y)</code> that use the step set <code>{ (0,1), (1,0), (2,0), (3,0), ....}</code> and never pass below <code>y =</code> x. Sequence gives <code>S(n-3,n)</code>.
