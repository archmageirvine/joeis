...
/**
 * A012257 Irregular triangle read by rows: row 1 is <code>{1,1}</code>; if row n is {r_1, <code>..</code>., r_k} then row <code>n+1</code> is {r_k 1's, r_{k-1} 2's, r_{k-2} 3's, etc.}.
