...
/**
 * A012869 Numerator of <code>[x^(2n+1)]</code> in the Taylor series arccos(cot(x)*arcsinh(x))= <code>x-x^3/15 +4*x^5/75 -2098*x^7/70875 +2969*x^9/141750 -35380322*x^11/2280403125 +</code>...
