...
/**
 * A013581 Let P <code>= 2*3*5*</code>..*p_n = n-th primorial number (A002110), G = Z_2xZ_3x...xZ_{p_n}; <code>a(n) =</code> max{e in G} min{i : both e+i, e-i are relatively prime to P}.
