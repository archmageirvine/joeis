...
/**
 * A013586 Smallest prime p such that n divides one of <code>f(p)-1, f(p)</code> or <code>f(p)+1</code>, where <code>f(p)</code> is product of primes <code>&lt;=</code> p, or 0 if no such p exists.
