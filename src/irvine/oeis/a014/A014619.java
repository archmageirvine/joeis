...
/**
 * A014619 Exponential generating function is -f(x) * int(exp(exp(-t)-1),t,0,x) where f(x) = exp(1-x-exp(-x)) is <code>an</code> exponential generating function for A014182.
