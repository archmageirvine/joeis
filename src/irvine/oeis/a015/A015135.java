...
/**
 * A015135 Consider Fibonacci-type sequences <code>f(0)=X, f(1)=Y, f(k)=f(k-1)+f(k-2) mod</code> n; all are periodic; sequence gives number of distinct period lengths.
