...
/**
 * A015137 Consider Fibonacci-type sequences b(0)=X, b(1)=Y, b(k)=b(k-1)+b(k-2) <code>mod n</code>; all are periodic; sequence gives number of nontrivial periods of minimal length.
