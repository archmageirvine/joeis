...
/**
 * A015138 Consider Fibonacci-type sequences <code>b(0)=X, b(1)=Y, b(k)=b(k-1)+b(k-2) mod</code> n; all are periodic; sequence gives number of maximal length periods.
