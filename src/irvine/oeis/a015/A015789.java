...
/**
 * A015789 Numbers k such that phi(k) <code>+ 10</code> | <code>sigma(k + 10)</code>.
 * @author Sean A. Irvine
 */
public class A015789 implements Sequence {
  ...
  public Z next() {
    while (true) {
      final Z phi10 = mFactorSequenceA.phi().add(10);
      ...
      if (mFactorSequenceJ.sigma().mod(phi10).equals(Z.ZERO)) {
