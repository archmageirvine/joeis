...
/**
 * A015822 Numbers k such that phi(k <code>+ 6)</code> | <code>sigma(k)</code>.
 * @author Sean A. Irvine
 */
public class A015822 implements Sequence {
  ...
  public Z next() {
    while (true) {
      ...
      if (sigma.mod(mFactorSequenceF.phi()).equals(Z.ZERO)) {
