...
/**
 * A015823 Numbers k such that phi(k <code>+ 7)</code> | <code>sigma(k)</code>.
 * @author Sean A. Irvine
 */
public class A015823 implements Sequence {
  ...
  public Z next() {
    while (true) {
      ...
      if (sigma.mod(mFactorSequenceG.phi()).equals(Z.ZERO)) {
