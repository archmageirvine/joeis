...
/**
 * A015872 Numbers n such that phi(n <code>+ 6)</code> | sigma(n) <code>+ 6</code>.
 * @author Sean A. Irvine
 */
public class A015872 implements Sequence {
  ...
  public Z next() {
    while (true) {
      ...
      if (sigma.add(6).mod(mFactorSequenceF.phi()).equals(Z.ZERO)) {
