...
/**
 * A018926 Number of ways to partition an n-cube into subcubes (without reducing isomorphic <code>cases)</code>; number of labeled squashed <code>n-cubes</code>; ways to make a tautology from disjoint terms with n Boolean variables; number of Rivest compression schemes for n-bit retrieval.
