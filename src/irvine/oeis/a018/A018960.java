...
/**
 * A018960 Cycle class sequence c(2n) (the number of true cycles of length <code>2n</code> in which a certain node is included) for zeolite AFR = SAPO-40 [ Si7Al29P28O128 <code>] </code>. 4 TPA . OH.
