...
/**
 * A018972 Cycle class sequence c(2n) (the number of true cycles of length <code>2n</code> in which a certain node is included) for zeolite AFY = CoAPO-50 R3 [ Co3Al5P8O32 <code>] </code>.7 H2O.
