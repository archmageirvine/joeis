...
/**
 * A018974 Cycle class sequence c(2n) (the number of true cycles of length 2n in which a certain node is included) for zeolite AHT = AlPO4-H2 [Al6P6O12].8H2O starting from a T1 atom.
