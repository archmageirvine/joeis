...
/**
 * A018976 Cycle class sequence c(2n) (the number of true cycles of length <code>2n</code> in which a certain node is included) for zeolite ANA = Analcime Na16[ Al16Si32O96 <code>] . 16</code> H2O.
