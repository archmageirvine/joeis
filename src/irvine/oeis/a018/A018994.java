...
/**
 * A018994 Cycle class sequence c(2n) (the number of true cycles of length <code>2n</code> in which a certain node is included) for zeolite BPH = Beryllophosphate-H Na7K7 [ Be14P14O56 <code>] </code>. 20 H2O.
