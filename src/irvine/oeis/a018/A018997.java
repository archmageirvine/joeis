...
/**
 * A018997 Cycle class sequence c(2n) (the number of true cycles of length <code>2n</code> in which a certain node is included) for zeolite CAN = Cancrinite Na6[ Al6Si6O24 <code>] </code>. CaCO3 . 2 H2O.
