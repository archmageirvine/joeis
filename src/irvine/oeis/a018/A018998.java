...
/**
 * A018998 Cycle class sequence c(2n) (the number of true cycles of length <code>2n</code> in which a certain node is included) for zeolite CHA = Chabazite Ca6[ Al12Si24O72 <code>] </code>. 40 H2O.
