...
/**
 * A019010 Cycle class sequence <code>c(2n)</code> (the number of true cycles of length <code>2n</code> in which a certain node is included) for zeolite EAB <code>= TMA-E</code> (Aiello and <code>Barrer)(1) (Me4N)2Na7[ Al9Si27O7</code>.
