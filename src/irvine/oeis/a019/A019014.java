...
/**
 * A019014 Cycle class sequence c(2n) (the number of true cycles of length 2n in which a certain node is included) for zeolite ERI = Erionite (Na2,Ca..)3.5K2[Al9Si27O72].27H2O starting with a T2 atom.
