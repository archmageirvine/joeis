...
/**
 * A019019 Cycle class sequence c(2n) (the number of true cycles of length 2n in which a certain node is included) for zeolite GOO = Goosecreekite Ca2[Al4Si12O32].10H2O starting with a T2 atom.
