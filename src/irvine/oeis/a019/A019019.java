...
/**
 * A019019 Cycle class sequence c(2n) (the number of true cycles of length <code>2n</code> in which a certain node is included) for zeolite GOO = Goosecreekite Ca2 [ Al4Si12O32 <code>] </code>. 10 H2O.
