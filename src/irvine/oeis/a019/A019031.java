...
/**
 * A019031 Cycle class sequence c(2n) (the number of true cycles of length <code>2n</code> in which a certain node is included) for zeolite LOS = Losod Na12 [ Al12Si12O48 <code>] </code>. 18 H2O.
