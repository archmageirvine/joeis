...
/**
 * A019034 Cycle class sequence c(2n) (the number of true cycles of length 2n in which a certain node is included) for zeolite LTL = Linde Type L K6Na3[Al9Si27O72].21H2O starting with a T2 atom.
