...
/**
 * A019043 Cycle class sequence c(2n) (the number of true cycles of length 2n in which a certain node is included) for zeolite OFF = Offretite (Ca,Mg)1.5K[Al4Si14O36].14H2O starting from a T2 atom.
