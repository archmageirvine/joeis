...
/**
 * A019057 Cycle class sequence c(2n) (the number of true cycles of length <code>2n</code> in which a certain node is included) for zeolite PHI = Phillipsite K2(Ca,Na2)2[ Al6Si10O32 <code>] . 12</code> H2O.
