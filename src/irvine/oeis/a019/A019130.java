...
/**
 * A019130 Cycle class sequence c(n) (the number of true cycles of length n in which a certain node is included) for zeolite FER = Ferrierite Na2Mg2[Al6Si30O72].18H2O starting with a T1 atom.
