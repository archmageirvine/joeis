...
/**
 * A019144 Cycle class sequence c(n) (the number of true cycles of length n in which a certain node is included) for zeolite MEI = ZSM-18 Nan[AlnSi34-nO68].28H2O (n=2.1-5.7) starting with a T2 atom.
