...
/**
 * A019155 Cycle class sequence <code>c(n) (the</code> number of true cycles of length n in which a certain node is included) for zeolite MEP = Melanophlogite <code>[ Si46O92 ]</code> . q R.
