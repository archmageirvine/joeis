...
/**
 * A019179 Cycle class sequence <code>c(n) (the</code> number of true cycles of length n in which a certain node is included) for zeolite MOR = Mordenite <code>Na8[ Al8Si40O96 ] . 24 H2O</code>.
