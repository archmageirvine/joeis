...
/**
 * A019183 Cycle class sequence <code>c(n) (the</code> number of true cycles of length n in which a certain node is included) for zeolite MTN <code>= ZSM-39 [ Si136O272 ]</code> . q R.
