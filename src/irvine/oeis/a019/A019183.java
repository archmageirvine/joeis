...
/**
 * A019183 Cycle class sequence <code>c(n)</code> (the number of true cycles of length n in which a certain node is included) for zeolite MTN = ZSM-39 [ Si136O272 <code>] </code>. q R.
