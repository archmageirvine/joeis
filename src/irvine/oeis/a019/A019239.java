...
/**
 * A019239 Cycle class sequence c(n) (the number of true cycles of length n in which a certain node is included) for zeolite STI = Stilbite Na4Ca8[Al20Si52O144].56H2O starting with a T4 atom.
