...
/**
 * A019268 Let Dedekind's psi(m) = product of (p+1)p^(e-1) for primes p, where p^e is a factor of m. Iterating psi(m) eventually results in a number of form 2^a*3^b. <code>a(n)</code> is the smallest number that requires n steps to reach such a number.
