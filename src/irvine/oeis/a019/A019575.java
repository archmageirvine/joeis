...
/**
 * A019575 Place n distinguishable balls in n boxes <code>(in n^n ways)</code>; let <code>T(n,k) =</code> number of ways that the maximum in any box is k, for <code>1 &lt;= k &lt;=</code> n; sequence gives triangle of numbers <code>T(n,k)</code>.
