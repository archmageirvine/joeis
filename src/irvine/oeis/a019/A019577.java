...
/**
 * A019577 Place n distinguishable balls in n boxes <code>(in n^n</code> ways); let <code>f(n,k) =</code> number of ways that max in <code>any</code> box is k, for <code>1&lt;=k&lt;=n</code>; sequence gives <code>f(n,2)/n</code>.
