...
/**
 * A019654 Consider problem of placing N queens on <code>an n</code> X n board so that each queen attacks precisely k others. Here <code>k=4</code> and sequence gives number of different solutions when N takes its maximal value.
