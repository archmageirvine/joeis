...
/**
 * A023500 <code>a(n) = b(n) + d(n)</code>, where <code>b(n) = (n-th</code> Fibonacci number <code>&gt; 1)</code> and <code>d(n) = (n-th</code> number that is <code>1, 2</code>, or 3, or is not a Lucas number).
