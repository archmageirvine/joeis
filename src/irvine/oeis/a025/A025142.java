...
/**
 * A025142 Fixed point of the square runlength transform, with <code>a(1) = 1</code> (the runlength transform of a binary sequence is the sequence of the lengths of its runs).
