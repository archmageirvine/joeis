...
/**
 * A026354 <code>a(n) = a(m)</code> if <code>a(m)</code> has already occurred exactly once and <code>n = a(m)+m-2</code>, else <code>a(n) =</code> least positive integer that has not yet occurred.
