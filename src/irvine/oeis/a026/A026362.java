...
/**
 * A026362 <code>a(n) = a(m)</code> if <code>a(m)</code> has already occurred exactly once and <code>n = a(m)+2m-1</code>, else <code>a(n) =</code> least positive integer that has not yet occurred.
