...
/**
 * A026504 <code>a(n) =</code> least positive integer <code>&gt; a(n-1)</code> and not <code>a(j)*a(k) + a(k)*a(i) + a(i)*a(j)</code> for <code>1&lt;=i&lt;=j&lt;=k&lt;=n</code>.
 * @author Sean A. Irvine
 */
public class A026504 extends MemorySequence {
