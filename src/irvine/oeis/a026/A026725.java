...
/**
 * A026725 Triangular array, T, read by rows: T(n,0) = T(n,n) = 1. For n &gt;= 2 and 1&lt;=k&lt;=n-1, T(n,k) = T(n-1,k-1) + T(n-2,k-1) + T(n-1,k) if n is odd and k=(n-1)/2, otherwise T(n,k) = T(n-1,k-1) + T(n-1,k).
