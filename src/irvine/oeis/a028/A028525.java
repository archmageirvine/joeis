...
/**
 * A028525 Character of extremal vertex operator algebra of rank 15.5.
 * @author Sean A. Irvine
 */
public class A028525 extends A000700 {
  ...
  private static final Q C1 = new Q(31, 24);
  ...
  public Z next() {
    ...
    final QPolynomial<Z> b = RING.subtract(RING.pow(a, 31, mN), RING.multiply(RING.pow(a, 7, mN), Z31));
