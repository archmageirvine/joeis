 ...
 */
public class A028586 extends Sequence0 {
  ...
  public Z next() {
    mN = mN.add(Q.HALF);
    final Q t = mN.divide(5);
    final QPolynomial<Z> a = RING.multiply(ThetaFunctions.theta3(mN), ThetaFunctions.theta3(t).substitutePower(5), mN);
    final QPolynomial<Z> b = RING.multiply(ThetaFunctions.theta2(mN), ThetaFunctions.theta2(t).substitutePower(5), mN);
