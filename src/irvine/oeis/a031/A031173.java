...
/**
 * A031173 Longest edge a of smallest (measured by the longest edge) primitive Euler bricks <code>(a</code>, b, c, <code>sqrt(a^2 + b^2), sqrt(b^2 + c^2), sqrt(a^2 + c^2)</code> are integers).
