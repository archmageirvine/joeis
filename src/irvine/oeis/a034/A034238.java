...
/**
 * A034238 Number of quaternary codes of length 7 with n words.
 * @author Sean A. Irvine
 */
public class A034238 implements Sequence {
  ...
  private final Polynomial<Q> mA = WreathExponentiation.exponentiation(Z4, Z7).applyOnePlusXToTheN();
  private int mN = -1;
