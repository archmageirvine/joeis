 ...
 */
public class A034603 extends Sequence0 {
  ...
  private final Series<Q> mS = SQ.add(
    SQ.multiply(SQ.multiply(SQ.pow(mThetaD4, 1), SQ.pow(mDelta8, 2)), Q.valueOf(3240)),
    SQ.multiply(SQ.multiply(SQ.pow(mThetaD4, 5), mDelta8), Q.valueOf(-216)),
    SQ.pow(mThetaD4, 9)
  );
