 ...
 */
public class A034604 extends Sequence0 {
  ...
  private final Series<Q> mS = SQ.add(
    SQ.multiply(SQ.multiply(SQ.pow(mThetaD4, 2), SQ.pow(mDelta8, 2)), Q.valueOf(6480)),
    SQ.multiply(SQ.multiply(SQ.pow(mThetaD4, 6), mDelta8), Q.valueOf(-240)),
    SQ.pow(mThetaD4, 10)
  );
