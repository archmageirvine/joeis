 ...
 */
public class A034606 extends Sequence0 {
  ...
  private final Series<Q> mS = SQ.add(
    SQ.multiply(SQ.pow(mDelta8, 3), Q.valueOf(-32256)),
    SQ.multiply(SQ.multiply(SQ.pow(mThetaD4, 4), SQ.pow(mDelta8, 2)), Q.valueOf(14688)),
    SQ.multiply(SQ.multiply(SQ.pow(mThetaD4, 8), mDelta8), Q.valueOf(-288)),
    SQ.pow(mThetaD4, 12)
  );
