 ...
 */
public class A034608 extends Sequence0 {
  ...
  private final Series<Q> mS = SQ.add(
    SQ.multiply(SQ.multiply(SQ.pow(mThetaD4, 2), SQ.pow(mDelta8, 3)), Q.valueOf(-215040)),
    SQ.multiply(SQ.multiply(SQ.pow(mThetaD4, 6), SQ.pow(mDelta8, 2)), Q.valueOf(25200)),
    SQ.multiply(SQ.multiply(SQ.pow(mThetaD4, 10), mDelta8), Q.valueOf(-336)),
    SQ.pow(mThetaD4, 14)
  );
