 ...
 */
public class A034609 extends Sequence0 {
  ...
  private final Series<Q> mS = SQ.add(
    SQ.multiply(SQ.multiply(SQ.pow(mThetaD4, 3), SQ.pow(mDelta8, 3)), Q.valueOf(-429120)),
    SQ.multiply(SQ.multiply(SQ.pow(mThetaD4, 7), SQ.pow(mDelta8, 2)), Q.valueOf(31320)),
    SQ.multiply(SQ.multiply(SQ.pow(mThetaD4, 11), mDelta8), Q.valueOf(-360)),
    SQ.pow(mThetaD4, 15)
  );
