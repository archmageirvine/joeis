 ...
 */
public class A034624 extends Sequence0 {
  ...
  private final Series<Q> mS = SQ.add(
    SQ.multiply(SQ.multiply(SQ.pow(mThetaA2, 2), SQ.pow(mDelta6, 2)), new Q(252)),
    SQ.multiply(SQ.multiply(SQ.pow(mThetaA2, 8), mDelta6), Q.valueOf(-84)),
    SQ.pow(mThetaA2, 14)
  );
