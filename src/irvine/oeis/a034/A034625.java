 ...
 */
public class A034625 extends Sequence0 {
  ...
  private final Series<Q> mS = SQ.add(
    SQ.multiply(SQ.multiply(SQ.pow(mThetaA2, 3), SQ.pow(mDelta6, 2)), new Q(540)),
    SQ.multiply(SQ.multiply(SQ.pow(mThetaA2, 9), mDelta6), Q.valueOf(-90)),
    SQ.pow(mThetaA2, 15)
  );
