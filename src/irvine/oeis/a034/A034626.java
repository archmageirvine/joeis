 ...
 */
public class A034626 extends Sequence0 {
  ...
  private final Series<Q> mS = SQ.add(
    SQ.multiply(SQ.multiply(SQ.pow(mThetaA2, 4), SQ.pow(mDelta6, 2)), new Q(864)),
    SQ.multiply(SQ.multiply(SQ.pow(mThetaA2, 10), mDelta6), Q.valueOf(-96)),
    SQ.pow(mThetaA2, 16)
  );
