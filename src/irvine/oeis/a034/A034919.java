...
/**
 * A034919 Minimal consecutive determinant (negated) of n X n persymmetric matrix with entries {-1,0,+1}.
 * @author Sean A. Irvine
 */
public class A034919 implements Sequence {
