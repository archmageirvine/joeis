...
// Generated by gen_seq4.pl juxdig12b 1 2 4 add at 2019-07-04 11:15
// DO NOT EDIT here!
...
/**
 * A043883 Numbers n such that 1 and 2 occur juxtaposed in the base 4 representation of n but not of <code>n+1</code>.
 * @author Georg Fischer
 */
public class A043883 implements Sequence {
  ...
  public Z next() {
    ...
    ++mN;
    if (loopCheck == 0) {
      throw new IllegalArgumentException("more than 10^6 iterations in A043883");
    }
    return mK;
  }
}
