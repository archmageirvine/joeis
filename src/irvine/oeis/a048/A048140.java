...
/**
 * A048140 Number of planar partitions of n, but partitions that are mirror images of each other (when regarded as <code>3-D objects)</code> are counted only once.
