...
/**
 * A048140 Number of planar partitions of <code>n,</code> but partitions that are mirror images of each other (when regarded as 3-D objects) are counted only once.
