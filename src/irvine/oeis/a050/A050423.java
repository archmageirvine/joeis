...
/**
 * A050423 Numbers for which in base 2 the least number of digits that can be removed to leave a palindrome (possibly beginning with 0) is 4.
 * @author Sean A. Irvine
 */
public class A050423 implements Sequence {

  private long mN = 231;

  static boolean is(final String s) {
    if (A050420.is(s) || A050421.is(s) || A050422.is(s)) {
      return false;
    }
