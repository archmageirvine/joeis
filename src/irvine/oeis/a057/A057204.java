...
/**
 * A057204 Primes congruent to <code>1 mod 6</code> generated recursively. Initial prime is <code>7.</code> The next term is p(n) = Min {p is prime; p divides 4Q^2+3; Mod[p,6]=1}, where Q is the product of previous entries of the sequence.
