...
/**
 * A057208 Primes of the form 8k+5 generated recursively: <code>a(1)=5, a(n) =</code> least prime p <code>== 5 (mod 8)</code> with p | 4+Q^2, where Q is the product of all previous terms in the sequence.
