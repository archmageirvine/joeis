...
/**
 * A057561 Size of the largest set encompassing no <code>{x, 2x, 3x}</code> contained in <code>D(n) =</code> the first n 3-smooth numbers <code>{1, 2, 3, 4, 6, 8, 9, 12, 16, 18, 24, 27,...}</code> (A003586).
