 ...
 */
public class A058519 extends Sequence0 {
  ...
  public Z next() {
    ...
    final Polynomial<Q> c = RING.sum(1, mN, k -> RING.multiply(RING.log1p(RING.negate(mB.substitutePower(k.intValue(), mN)), mN), new Q(-Functions.PHI.l(k), k)));
