...
public class A058819 implements Sequence {
  ...
  public Z next() {
    ++mN;
    return mN <= 1 ? Z.valueOf(4).pow(mN) : Z.valueOf(4).pow(mN).subtract(Integers.SINGLETON.sumdiv(mN, d -> Z.valueOf(4).pow(mN / d).multiply(irvine.math.Mobius.mobius(d))).divide(mN));
  }
}
