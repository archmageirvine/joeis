...
public class A058820 extends Sequence0 {
  ...
  public Z next() {
    ++mN;
    return mN <= 1 ? Z.valueOf(5).pow(mN) : Z.valueOf(5).pow(mN).subtract(Integers.SINGLETON.sumdiv(mN, d -> Z.valueOf(5).pow(mN / d).multiply(irvine.math.Mobius.mobius(d))).divide(mN));
  }
}
