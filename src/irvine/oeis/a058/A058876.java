...
/**
 * A058876 Triangle read by rows: T(n,k) = number of labeled acyclic digraphs with n nodes, containing exactly <code>n+1-k</code> points of in-degree zero <code>(n &gt;= 1, 1&lt;=k&lt;=n)</code>.
