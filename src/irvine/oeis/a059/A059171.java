...
public class A059171 implements Sequence {
  ...
  public Z next() {
    ...
    return RING.subtract(RING.subtract(RING.x(), RING.series(RING.pow(RING.x(), 2, mN), RING.monomial(new Q(2), 0), mN)), RING.multiply(RING.x(), RING.log(RING.oneMinusXToTheN(1), mN), mN)).coeff(mN).multiply(mF).toZ();
  }
}
