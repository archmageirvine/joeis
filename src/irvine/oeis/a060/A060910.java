...
public class A060910 implements Sequence {
  ...
  public Z next() {
    ...
    return RING.exp(RING.add(RING.add(RING.multiply(RING.x(), RING.exp(RING.multiply(RING.x(), RING.exp(RING.x(), mN), mN), mN), mN), RING.multiply(RING.multiply(RING.series(RING.one(), RING.monomial(new Q(2), 0), mN), RING.pow(RING.x(), 2, mN), mN), RING.pow(RING.exp(RING.multiply(RING.x(), RING.exp(RING.x(), mN), mN), mN), 2, mN), mN)), RING.multiply(RING.multiply(RING.series(RING.one(), RING.monomial(new Q(4), 0), mN), RING.pow(RING.x(), 4, mN), mN), RING.pow(RING.exp(RING.multiply(RING.x(), RING.exp(RING.x(), mN), mN), mN), 4, mN), mN)), mN).coeff(mN).multiply(mF).toZ();
  }
}
