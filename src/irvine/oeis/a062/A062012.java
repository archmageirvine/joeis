...
public class A062012 extends FiniteSequence {
  ...
  public A062012() {
    super(new Z[]{new Z("21"),new Z("1066338805156287287067"),new Z("1124161332414632881704"),new Z("2305867155177711644802"),new Z("2306166776784312535170"),new Z("5744341611556736174883")});
  }
}
