...
/**
 * A063953 Of course every number is the sum of 4 squares; these are the numbers not of the form <code>4m+2</code> such that the first square can be taken to be any square <code>&lt; n</code>.
