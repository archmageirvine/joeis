...
/**
 * A069907 Number of hexagons that can be formed with perimeter n. In other words, partitions of n into six parts such that the sum of <code>any 5</code> is more than the sixth.
