...
/**
 * A069907 Number of hexagons that can be formed with perimeter <code>n</code>. In other words, partitions of n into six parts such that the sum of any 5 is more than the sixth.
