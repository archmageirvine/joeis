...
public class A072236 extends LambdaSequence {
  ...
  public A072236() {
    ...
    super(0, n -> Functions.PRIME_PI.z(Integers.SINGLETON.product(1, n + 1, i -> Puma.primeZ(i)))
      .subtract(Functions.PRIME_PI.z(Integers.SINGLETON.product(1, n, i -> Puma.primeZ(i)))));
  }
}
