...
/**
 * A073564 Number of Fibonacci numbers F(k), k &lt;= 10^n, whose initial digit is 8.
 * @author Sean A. Irvine
 */
public class A073564 extends Sequence1 {
  ...
  private static final CR S = CR.FIVE.subtract(CR.EIGHT.log().divide(LOG_PHI));
  private static final CR T = CR.FIVE.subtract(CR.NINE.log().divide(LOG_PHI));
