...
/**
 * A074111 Smallest n-digit squarefree number with maximum number of prime divisors.
 * @author Sean A. Irvine
 */
public class A074111 extends Sequence1 implements Conjectural {
  ...
  public Z next() {
    ...
    return mCandidates.higherKey(min);
  }
}
