 ...
 */
public class A074362 extends Sequence0 {

  private static final PolynomialRing<Z> RING = new PolynomialRing<>(Integers.SINGLETON);
  private Polynomial<Z> mA = RING.one();
  private Polynomial<Z> mB = Polynomial.create(3);
  private int mN = -1;
  ...
  public Z next() {
    if (++mN > 1) {
      ...
      Arrays.fill(q, Z.ONE);
      final Polynomial<Z> t = RING.add(RING.multiply(mB, Z.THREE), RING.multiply(Polynomial.create(q), mA));
      mA = mB;
      mB = t;
    }
    return mB.coeff(2);
