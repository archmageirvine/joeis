...
/**
 * A078433 Number of permutations p of 1,2,...,n such that the numerator of the continued fraction [p(1); p(2),...,p(n)] is prime.
 * @author Sean A. Irvine
 */
public class A078433 extends Sequence1 {
