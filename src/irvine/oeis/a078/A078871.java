...
/**
 * A078871 Decimal concatenations of the 6-tuples (d1,d2,d3,d4,d5,d6) with elements in <code>{2,4,6}</code> for which there exists a prime p <code>&gt;= 7</code> such that the differences between the 7 consecutive primes starting with p are (d1,d2,d3,d4,d5,d6).
