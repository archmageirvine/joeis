...
/**
 * A079042 Numbers n in which the first k digits of n form <code>an</code> integer divisible by k^2, for k <code>= 1, 2, </code>..., m, where m is the number of digits in n.
