 ...
 */
public class A079520 extends Sequence0 {
  ...
  public Z next() {
    ...
    if (mN - mM >= mColumns.size()) {
      mColumns.add(SQ.multiply(SQ.shift(mD, mN + 1), SQ.pow(mC, mN + 3)));
    }
    return mColumns.get(mN - mM).coeff(mN).toZ();
  }
}
