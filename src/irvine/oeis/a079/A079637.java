...
/**
 * A079637 Smallest prime p with audioactive "echo" of at least n, that is, the finite sequence <code>p_0 =</code> p, <code>p_1 = LookAndSay(p_0)</code>, ..., <code>p_n = LookAndSay(p_(n-1))</code> consists entirely of primes.
