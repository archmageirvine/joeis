 ...
 */
public class A080360 extends Sequence1 {

  private final Fast mPrime = new Fast();
  private final LongDynamicLongArray mLast = new LongDynamicLongArray();
  private long mM = 0;
  private long mN = 0;
  private long mQ = 2;
  ...
  public Z next() {
    ...
    while (mM <= 2 * mQ) {
      ...
      if (cnt > 0 && cnt < mN) {
        throw new RuntimeException("Previously reported value for " + cnt + " was incorrect, it should be >= " + mM);
      }
      mLast.set(cnt, mM);
    }
