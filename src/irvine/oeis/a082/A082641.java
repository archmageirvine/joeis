...
/**
 * A082641 Triangle T(n,k) <code>(n &gt;= 1, 1 &lt;=</code> k <code>&lt;= n)</code> read by rows, where T(n,k) = number of basic invariants of degree k for the cyclic group of order and degree n.
