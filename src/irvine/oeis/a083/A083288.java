...
/**
 * A083288 Sigma unitary-sigma perfect numbers: numbers n which satisfy the following equation for some integer k: sigma(usigma(n)) = k*n where usigma(n) is sum of unitary divisors of n.
