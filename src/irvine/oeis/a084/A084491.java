 ...
 */
public class A084491 extends A084452 {

  private static final Z NEG3 = Z.valueOf(-3);
  private final DirectSequence mA = DirectSequence.create(new A084501());
  private final DirectSequence mB = DirectSequence.create(new A084490());
  private long mN = 0;
