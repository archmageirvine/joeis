 ...
 */
public class A084499 extends A084452 {

  private static final Z NEG3 = Z.valueOf(-3);
  private final DirectSequence mA = DirectSequence.create(new A084521());
  private final DirectSequence mB = DirectSequence.create(new A084498());
  private long mN = 0;
