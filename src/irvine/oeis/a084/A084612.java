 ...
 */
public class A084612 extends LambdaTable {

  /** Construct the sequence. */
  public A084612() {
    super(0, 0, n -> new Integer[]{0, n * 2}, (n, k) -> Integers.SINGLETON.sum(0, k, j -> Binomial.binomial(n, k - j).multiply(Binomial.binomial(k - j, j)).multiply(Z.valueOf(-2).pow(j))));
  }
}
