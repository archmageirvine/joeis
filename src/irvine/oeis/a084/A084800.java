...
/**
 * A084800 Least positive integers, all distinct, that satisfy Sum_{n&gt;0} 1/a(n)^z = 0, where z=(4+I*3)/5.
 * @author Sean A. Irvine
 */
public class A084800 extends Sequence1 {

  private static final ComputableComplexField F = ComputableComplexField.SINGLETON;
  private static final CC X = new CC(CR.valueOf(new Q(4, 5)), CR.valueOf(new Q(3, 5)));
