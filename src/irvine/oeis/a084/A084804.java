...
/**
 * A084804 Least positive integers, all distinct, that satisfy Sum_{n&gt;0} 1/a(n)^z = 0, where z=(60+I*11)/61.
 * @author Sean A. Irvine
 */
public class A084804 extends Sequence1 {

  private static final ComputableComplexField F = ComputableComplexField.SINGLETON;
  private static final CC X = new CC(CR.valueOf(new Q(60, 61)), CR.valueOf(new Q(11, 61)));
