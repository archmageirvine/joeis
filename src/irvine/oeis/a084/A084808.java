...
/**
 * A084808 Least positive integers, all distinct, that satisfy sum(n&gt;0,1/a(n)^z)=0, where z=1/2+I*sqrt(2).
 * @author Sean A. Irvine
 */
public class A084808 extends Sequence1 {

  private static final ComputableComplexField F = ComputableComplexField.SINGLETON;
  private static final CC X = new CC(CR.HALF, CR.SQRT2);
