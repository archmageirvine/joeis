...
/**
 * A084817 Least integers that satisfy Sum_{n&gt;=1} 1/a(n)^z = 0, where a(1)=1, a(n+1)&gt;a(n) and z=I/log(2).
 * @author Sean A. Irvine
 */
public class A084817 extends Sequence1 {

  private static final ComputableComplexField F = ComputableComplexField.SINGLETON;
  private static final CC X = new CC(CR.ZERO, CR.LOG2.inverse());
