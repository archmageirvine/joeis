 ...
 */
public class A084878 extends Sequence0 {
  ...
  public Z next() {
    ...
    return Z.valueOf(729).pow(mN)
      ...
      .add(Z.valueOf(243).pow(mN).multiply(15))
      ...
      .subtract(Z.valueOf(162).pow(mN).multiply(300))
      ...
      .add(Z.valueOf(126).pow(mN).multiply(900))
      .subtract(Z.valueOf(120).pow(mN).multiply(360))
      .add(Z.valueOf(111).pow(mN).multiply(180))
      .add(Z.valueOf(108).pow(mN).multiply(300))
      .subtract(Z.valueOf(102).pow(mN).multiply(20))
      .add(Z.valueOf(98).pow(mN).multiply(150))
      .subtract(Z.valueOf(93).pow(mN).multiply(1800))
      .subtract(Z.valueOf(84).pow(mN).multiply(1800))
      .add(Z.valueOf(81).pow(mN).multiply(85))
      .add(Z.valueOf(78).pow(mN).multiply(450))
      .add(Z.valueOf(77).pow(mN).multiply(1800))
      .add(Z.valueOf(70).pow(mN).multiply(1800))
      .subtract(Z.valueOf(63).pow(mN).multiply(1800))
      .add(Z.valueOf(56).pow(mN).multiply(300))
      .subtract(Z.valueOf(54).pow(mN).multiply(1020))
      .add(Z.valueOf(42).pow(mN).multiply(2040))
      .add(Z.valueOf(36).pow(mN).multiply(340))
      .subtract(Z.valueOf(31).pow(mN).multiply(2040))
      .add(Z.valueOf(27).pow(mN).multiply(225))
      .add(Z.valueOf(26).pow(mN).multiply(510))
      .subtract(Z.valueOf(18).pow(mN).multiply(1350))
      .add(Z.valueOf(14).pow(mN).multiply(1350))
      .add(Z.NINE.pow(mN).multiply(274))
      .subtract(Z.SIX.pow(mN).multiply(548))
      .add(Z.THREE.pow(mN).multiply(120))
      .divide(720);
  }
}
