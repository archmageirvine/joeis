...
/**
 * A086630 Main diagonal of square table A086629; coefficients of x^n*y^n in f(x,y) that satisfies f(x,y) = 1/((1-x)*(1-y)) + x*y*f(x,y)^3.
 * @author Sean A. Irvine
 */
public class A086630 extends Sequence0 {
