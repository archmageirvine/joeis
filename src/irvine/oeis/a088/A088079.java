...
/**
 * A088079 Diagonal T(n,n) of the triangle T(n,k), <code>n&gt;=0,</code> 0&lt;=k&lt;=n, in which row n contains <code>n+1</code> consecutive integers T(n,k+1)=T(n,k)+1 such that T(n,k) is divisible by a k-th power.
