...
public class A089004 implements Sequence {
  ...
  public Z next() {
    ...
    return RING.multiply(RING.exp(RING.subtract(RING.cosh(RING.x(), mN), RING.one()), mN), RING.subtract(RING.exp(RING.sinh(RING.x(), mN), mN), RING.one()), mN).coeff(mN).multiply(mF).toZ();
  }
}
