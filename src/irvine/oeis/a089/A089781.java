...
/**
 * A089781 Successive coprime numbers with distinct successive differences: gcd(a(k+1),a(k)) = gcd(a(m+1),a(m)) <code>= 1</code> and <code>a(k+1)-a(k) =</code> a(m+1)-a(m) <code>&lt;==&gt;</code> m=k.
