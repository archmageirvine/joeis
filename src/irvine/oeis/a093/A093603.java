...
/**
 * A093603 Bisecting a triangular cake using a curved cut of minimal length: decimal expansion of <code>sqrt(Pi/sqrt(3))/2 = d/2</code>, where <code>d^2 = Pi/sqrt(3)</code>.
