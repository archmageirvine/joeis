...
/**
 * A093729 Square table T, read by antidiagonals, where <code>T(n,k)</code> gives the number of n-th generation descendents of a node labeled (k) in the tree of tournament sequences.
