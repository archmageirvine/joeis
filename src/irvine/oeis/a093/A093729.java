...
/**
 * A093729 Square table T, read by antidiagonals, where T(n,k) gives the number of n-th generation descendents of a node labeled <code>(k)</code> in the tree of tournament sequences.
