...
/**
 * A093906 Start with <code>{2}</code> and close under the operations XY and <code>XY+1</code>; sequence gives complete list of numbers that do not appear.
