...
/**
 * A094152 <code>a(n)</code> is the position of prime 7 in the Euclid-Mullin (EM) sequence of type A000945, if it were started with <code>prime(n)</code> instead of 2.
