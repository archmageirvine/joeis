...
/**
 * A094152 <code>a(n)</code> is the position of prime 7 in the <code>Euclid-Mullin (EM)</code> sequence of type <code>A000945</code>, if it were started with <code>prime(n)</code> instead of 2.
