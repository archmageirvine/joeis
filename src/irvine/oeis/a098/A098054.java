...
/**
 * A098054 Absolute values of elements of flattened successive matrices B(k), k&gt;=0, read by rows where B(k) = M^k*C where M=[[2, -1], [-1, 1]] and C = [[0, 1], [1, 1]].
 * @author Sean A. Irvine
 */
public class A098054 extends Sequence0 {
