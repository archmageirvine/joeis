...
/**
 * A101811 Numerator of the permanent of the n-th Hilbert matrix.
 * @author Georg Fischer
 */
public class A101811 extends AbstractSequence {
  ...
  public Z next() {
    ...
    return new MatrixField<Q>(mN, Rationals.SINGLETON).permanent(mat).num();
  }
}
