 ...
 */
public class A110626 extends LambdaSequence {

  /** Construct the sequence. */
  public A110626() {
    super(1, n -> Rationals.SINGLETON.sum(1, n, k -> new Q(2 * Long.bitCount(k) - IntegerUtils.floorLog2(k.intValue()) - 1, 2 * k * (2L * k + 1))).den());
  }
}
