 ...
 */
public class A111655 extends LambdaTable {

  /** Construct the sequence. */
  public A111655() {
    super(1, 1, n -> new Integer[] {1, DirectSequence.create(new A002808()).a(n).intValueExact()}, (n, k) -> DirectSequence.create(new A002808()).a(n));
  }
}
