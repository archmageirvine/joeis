 ...
 */
public class A111891 extends MultiTransformSequence {

  /** Construct the sequence. */
  public A111891() {
    super(1, (self, n) -> CR.valueOf(n).sqrt().multiply(CR.valueOf(100)).floor().mod(10) == 1 ? self.a(n - 1).add(1) : self.a(n - 1), "0");
  }
}
