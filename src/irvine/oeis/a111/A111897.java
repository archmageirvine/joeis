 ...
 */
public class A111897 extends MultiTransformSequence {

  /** Construct the sequence. */
  public A111897() {
    super(1, (self, n) -> CR.valueOf(n).sqrt().multiply(CR.valueOf(100)).floor().mod(10) == 7 ? self.a(n - 1).add(1) : self.a(n - 1), "0");
  }
}
