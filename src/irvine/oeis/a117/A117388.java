...
/**
 * A117388 <code>a(n)</code> is the smallest n-digit integer such that, if all numbers formed by inserting the exponentiation symbol between <code>any</code> two digits are added up, the sum is prime.
