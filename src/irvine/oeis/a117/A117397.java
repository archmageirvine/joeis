...
public class A117397 extends LambdaSequence {
  ...
  public A117397() {
    super(0, n -> (Z.ONE).add(Integers.SINGLETON.sum(4, n + 3, k -> MemoryFactorial.SINGLETON.factorial(k)).multiply(Z.THREE).divide(MemoryFactorial.SINGLETON.factorial(4))));
  }
}
