...
/**
 * A118879 Let T(S,Q) be the sequence obtaining by starting with S and repeatedly reversing the digits and adding Q to get the next term. This is <code>T(1016,5)</code>, the first S for which T(S,5) reaches a cycle of length 36.
