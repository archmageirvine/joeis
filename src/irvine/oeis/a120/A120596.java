 ...
 * holdfin(A120596, 0,-37531*(n-3)*(n-2)*(n-1)*n+781250*(n-1)*(n-2)*(n-3)*(2*n-3)*A+46875*(n-2)*(n-3)*(10*n^2-40*n+39)*A^2+3125*(n-3)*(2*n-5)*(10*n^2-50*n+57)*A^3+5*(5*n-9)*(5*n-13)*(5*n-17)*(5*n-21)*A^4,[1, 1, 10, 210],"a(n)");
