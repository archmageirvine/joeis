 ...
 * holdfin(A123, 0,-9049*(n-3)*(n-2)*(n-1)*n*A^4+100000*(n-1)*(n-2)*(n-3)*(2*n-3)*A^3+30000*(n-2)*(n-3)*(10*n^2-40*n+39)*A^2+10000*(n-3)*(2*n-5)*(10*n^2-50*n+57)*A+80*(5*n-9)*(5*n-13)*(5*n-17)*(5*n-21), [1, 2, 10, 120], "a(n)");
