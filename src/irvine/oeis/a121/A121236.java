...
public class A121236 extends FiniteSequence {
  ...
  public A121236() {
    super(new Z("7919"), new Z("604801"), new Z("10200959"), new Z("44351999"), new Z("44352001"), new Z("50232961"), new Z("244823041"), new Z("460815505919"), new Z("64561751654399"), new Z("4089470473293004801"), new Z("4157776806543360001"), new Z("86775571046077562879"));
  }
}
