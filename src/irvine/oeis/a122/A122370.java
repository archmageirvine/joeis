...
/**
 * A122370 Dimension of <code>6-variable non-commutative</code> harmonics <code>(twisted derivative)</code>. The dimension of the space of non-commutative polynomials in 6 variables which are killed by all symmetric differential operators (where for a monomial w, <code>d_{xi} (</code> xi w <code>) =</code> w and <code>d_{xi} (</code> xj w <code>) = 0</code> for <code>i/=j)</code>.
