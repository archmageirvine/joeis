...
/**
 * A122749 Number of arrangements of <code>n non-attacking</code> bishops on an <code>n X n</code> board such that every square of the board is controlled by at least one bishop.
