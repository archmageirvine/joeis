...
public class A123301 extends AbstractSequence {
   ...
   */
  protected A123301(final int offset) {
    super(offset);
  }
  ...
  /**
   * A series reversion that supports non-unit [x^1] coefficient.
   * @param ring ring we are in
   * @param a polynomial
   * @param degree degree of reversion
   * @return reversion
   */
  public static Polynomial<Polynomial<Q>> reversion(final PolynomialRingField<Polynomial<Q>> ring, final Polynomial<Polynomial<Q>> a, final int degree) {
