...
/**
 * A123513 Triangle read by rows: <code>T(n,k)</code> is the number of permutations of <code>[n]</code> having k small descents <code>(n &gt;= 1; 0 &lt;= k &lt;= n-1)</code>. A small descent in a permutation <code>(x_1,x_2,...,x_n)</code> is a position i such that <code>x_i - x_(i+1) = 1</code>.
