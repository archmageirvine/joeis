...
public class A129591 extends LambdaSequence {
  ...
  public A129591() {
    super(1, n -> Integers.SINGLETON.sum(0, n - 1, k -> Z.valueOf(n - k + 1).multiply(MemoryFactorial.SINGLETON.factorial(k)).multiply(Z.valueOf(k + 1).pow(n - k).subtract(Z.valueOf(k).pow(n - k)))));
  }
}
