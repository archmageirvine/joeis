...
/**
 * A133922 <code>a(n) =</code> number of permutations (p(1),p(2),p(3),...p(n)) of <code>(1,2,3,</code>...n) such that p(k) is coprime to p(n+1-k) for k = all positive integers <code>&lt;=n</code>.
