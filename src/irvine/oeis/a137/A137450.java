...
/**
 * A137450 A038610(n) (the LCM of the positive integers that are <code>&lt;= n</code> and are coprime to <code>n)</code> is the a(n)-th positive integer that is coprime to n.
