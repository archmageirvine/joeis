...
public class A141004 extends MultiTransformSequence {
  ...
  public A141004() {
    super(0, (self, n) -> Integers.SINGLETON.sum(1, n, j -> self.a(n - j).multiply(Integers.SINGLETON.sumdiv(6, d -> Z.valueOf(d).pow(j - 1))).multiply(Binomial.binomial(n - 1, j - 1))), "1");
  }
}
