...
/**
 * A146526 <code>a(n) =</code> the smallest positive integer m with exactly n (no more, no fewer) distinct primes represented in binary as substrings within the binary representation of m.
