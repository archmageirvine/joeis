...
/**
 * A146526 <code>a(n) =</code> the smallest positive integer m with exactly <code>n (no</code> more, no fewer) distinct primes represented in binary as substrings within the binary representation of m.
