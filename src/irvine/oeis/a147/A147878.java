 ...
 */
public class A147878 extends SingleTransformSequence {

  /** Construct the sequence. */
  public A147878() {
    super(1, (term, n) -> Functions.PARTITIONS.z(2 * n).subtract(Z.TWO.multiply(term)).add(Z.TWO.multiply(Functions.PARTITIONS.z(n))).add(Functions.PARTITIONS.z(n - 1)), "", new A000070());
  }
}
