 ...
 */
public class A151525 extends MultiTransformSequence {

  /** Construct the sequence. */
  public A151525() {
    super(1, (self, n) -> Z.FOUR.multiply(self.s(0)).add(Z.THREE.multiply(self.s(1))).add(Z.TWO.multiply(self.s(2))).add(Z.TWO.multiply(self.s(3))).add(Z.TWO.multiply(self.s(4))).add(self.s(5)).add(self.s(6)).add(self.s(7)), "", new A006749(), new A006746(), new A006748(), new A006747(), new A056877(), new A056878(), new A144553(), new A142886());
  }
}
