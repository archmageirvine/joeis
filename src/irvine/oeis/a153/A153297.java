 ...
 */
public class A153297 implements Sequence {
  ...
  public Z next() {
    ...
    return Integers.SINGLETON.sum(0, mN, k -> Binomial.binomial(2L * k + 2, k).multiply(Binomial.binomial(3L * mN - k, mN - k)).multiply(2L * k).divide(k + 1).divide(3L * mN - k));
  }
}
