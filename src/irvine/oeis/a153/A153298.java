 ...
 */
public class A153298 extends Sequence0 {
  ...
  public Z next() {
    ...
    return Integers.SINGLETON.sum(0, mN, k -> Binomial.binomial(2L * k + 2, k).multiply(Binomial.binomial(3L * mN, mN - k)).multiply(k).divide(1L * k + 1).divide(mN));
  }
}
