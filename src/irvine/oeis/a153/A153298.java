 ...
 */
public class A153298 implements Sequence {
  ...
  public Z next() {
    ...
    return Integers.SINGLETON.sum(0, mN, k -> Binomial.binomial(2 * k + 2, k).multiply(Binomial.binomial(3 * mN, mN - k)).multiply(k).divide(1 * k + 1).divide(mN));
  }
}
