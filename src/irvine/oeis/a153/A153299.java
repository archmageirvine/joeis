 ...
 */
public class A153299 implements Sequence {
  ...
  public Z next() {
    ...
    return Integers.SINGLETON.sum(0, mN, k -> Binomial.binomial(3 * k + 1, k).multiply(Binomial.binomial(2 * mN - k, mN - k)).multiply(k).divide(3 * k + 1).divide(2 * mN - k));
  }
}
