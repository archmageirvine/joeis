 ...
 */
public class A153299 extends Sequence0 {
  ...
  public Z next() {
    ...
    return Integers.SINGLETON.sum(0, mN, k -> Binomial.binomial(3L * k + 1, k).multiply(Binomial.binomial(2L * mN - k, mN - k)).multiply(k).divide(3L * k + 1).divide(2L * mN - k));
  }
}
