 ...
 */
public class A153391 implements Sequence {
  ...
  public Z next() {
    ...
    return Integers.SINGLETON.sum(0, mN, k -> Binomial.binomial(3L * k + 1, k).multiply(Binomial.binomial(2L * mN, mN - k)).multiply(k).divide(3L * k + 1).divide(mN));
  }
}
