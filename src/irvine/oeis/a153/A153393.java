 ...
 */
public class A153393 implements Sequence {
  ...
  public Z next() {
    ...
    return Integers.SINGLETON.sum(0, mN, k -> Binomial.binomial(3L * k + 2, k).multiply(Binomial.binomial(2L * mN, mN - k)).multiply(2L * k).divide(3L * k + 2).divide(mN));
  }
}
