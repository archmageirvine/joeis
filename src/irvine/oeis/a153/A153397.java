 ...
 */
public class A153397 implements Sequence {
  ...
  public Z next() {
    ...
    return Integers.SINGLETON.sum(0, mN, k -> Binomial.binomial(2L * k + 1, k).multiply(Binomial.binomial(4L * mN, mN - k)).multiply(k).divide(2L * k + 1).divide(mN));
  }
}
