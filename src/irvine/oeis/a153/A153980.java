...
/**
 * A153980 Positive integers n equal to the sum of all the different integers formed by the digits of <code>n (n</code> itself <code>excluded)</code>, keeping the order of the digits.
