...
/**
 * A156819 Last digit d of <code>a(n)</code> is present in <code>a(n+1+d); a(1)=0; a(n+1)</code> is always the smallest available integer not already in the sequence and not leading to a contradiction.
