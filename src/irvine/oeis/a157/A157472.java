...
/**
 * A157472 Decimal expansion of <code>(627 + 238*sqrt(2))/23^2</code>.
 * @author Georg Fischer
 */
public class A157472 extends DecimalExpansionSequence {

  private static final ComputableReals REALS = ComputableReals.SINGLETON;
  private static final CR N = CR.valueOf(627).add(CR.valueOf(238).multiply(CR.SQRT2)).divide(REALS.pow(CR.valueOf(23), CR.TWO));
