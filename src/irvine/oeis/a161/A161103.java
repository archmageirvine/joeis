 ...
 */
public class A161103 implements Sequence {
  ...
  public Z next() {
    ...
    for (int k = 1; k <= mN; ++k) {
      final int expon = k * (k + 1) / 2; // nonzero trianglualr numbers
