...
public class A161937 implements Sequence {
  ...
  public Z next() {
    ...
    return RING.series(RING.multiply(RING.x(), RING.exp(RING.subtract(RING.zero(), RING.x()), mN), mN), RING.subtract(RING.one(), RING.monomial(new Q(2), 1)), mN).coeff(mN).multiply(mF).toZ();
  }
}
