 ...
 */
public class A163541 extends MultiTransformSequence {

  private static final DirectSequence A010873 = new A010873();

  /** Construct the sequence. */
  public A163541() {
    super(1, (self, n) -> A010873.a(self.s(2).add(self.s(1)).add((self.s(2)).abs()).add(3)), "", new A163538(), new A163539(), new A163538());
  }
}
