...
/**
 * A165418 <code>a(1) = 1</code>. For <code>n &gt;= 2, a(n) =</code> sum a(k), where k is over the distinct values of the substrings in binary <code>n,</code> and where <code>1 &lt;=</code> k <code>&lt; n</code>.
