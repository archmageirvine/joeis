...
/**
 * A165740 Positive integers n such that solution to the toric <code>n X n</code> "Lights Out" puzzle is not unique (up to the order of flippings; each flipping appears at most once).
