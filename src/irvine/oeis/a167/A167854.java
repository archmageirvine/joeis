...
/**
 * A167854 Number of reduced words of length n in Coxeter group on 44 generators <code>S_i</code> with relations <code>(S_i)^2 = (S_i S_j)^15 =</code> I.
  ...
  public A167854() {
    super(new long[] {-903, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42},
      new Z[] {
        ...
        new Z("3250955723142094165678810")
      }, Z.ONE);
  }
}
