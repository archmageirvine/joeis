...
public class A173514 extends TupleTransformSequence {
  ...
  public A173514() {
    super(0, (n, s) -> s[0].multiply(2).add(s[1]).subtract(s[1].divide(2)).subtract(s[3].divide(2)).subtract(s[4].divide(2)), "1, 1, 3, 7, 16", PREVIOUS, PREVIOUS, PREVIOUS, PREVIOUS, PREVIOUS);
  }
}
