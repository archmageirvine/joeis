...
public class A174764 extends LambdaSequence {
  ...
  public A174764() {
    super(1, n -> Integers.SINGLETON.sum(0, n / 2, k -> {
      return Z.valueOf(k).multiply(k).multiply(Functions.FACTORIAL.z(n)).divide(Functions.FACTORIAL.z(n - 2 * k).multiply(Z.ONE.shiftLeft(k)).multiply(Functions.FACTORIAL.z(k)));
    }));
  }
}
