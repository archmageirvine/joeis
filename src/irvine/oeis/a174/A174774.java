...
public class A174774 extends LambdaSequence {
  ...
  public A174774() {
    super(1, n -> Integers.SINGLETON.sum(0, n / 2, k -> Z.valueOf(k).pow(3).multiply(Functions.FACTORIAL.z(n)).divide(Functions.FACTORIAL.z(n - 2 * k).multiply(Z.ONE.shiftLeft(k)).multiply(Functions.FACTORIAL.z(k)))));
  }
}
