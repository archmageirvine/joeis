...
public class A174782 extends LambdaSequence {
  ...
  public A174782() {
    super(1, n -> Integers.SINGLETON.sum(0, n / 2, k -> Z.valueOf(k).pow(4).multiply(MemoryFactorial.SINGLETON.factorial(n)).divide(MemoryFactorial.SINGLETON.factorial(n - 2 * k).multiply(Z.ONE.shiftLeft(k)).multiply(MemoryFactorial.SINGLETON.factorial(k)))));
  }
}
