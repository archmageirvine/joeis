...
/**
 * A175481 <code>a(1)=1. a(n+1) =</code> sum(k=1 to <code>n} b(n,a(k)),</code> where <code>b(n,a(k))</code> is the largest positive integer that, when written in binary, occurs as a substring in both binary n and binary <code>a(k)</code>.
