...
public class A186367 implements Sequence {
  ...
  public Z next() {
    ...
    return RING.negate(RING.series(RING.log(RING.subtract(RING.one(), RING.sin(RING.x(), mN)), mN), RING.subtract(RING.one(), RING.sin(RING.x(), mN)), mN)).coeff(mN).multiply(mF).toZ();
  }
}
