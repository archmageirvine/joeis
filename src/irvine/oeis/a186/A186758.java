 ...
 * E.g.f.: exp(1+x-exp(x))/(1-x)
 * @author Georg Fischer
 */
public class A186758 implements Sequence {
  ...
  public Z next() {
    ...
    return RING.series(RING.exp(RING.subtract(RING.onePlusXToTheN(1), RING.exp(RING.x(), mN)), mN), RING.oneMinusXToTheN(1), mN).coeff(mN).multiply(mF).toZ();
  }
}
