...
public class A189932 extends FloorSequence {
  ...
  private final CR mS = CR.ONE.subtract(CR.ONE.divide(CR.FIVE).multiply(CR.PI).cos().square());
  private final CR mT = CR.ONE.divide(CR.FIVE).multiply(CR.PI).cos().square();
