...
/**
 * A190207 <code>a(n) = [n*u + n*v] - [n*u] - [n*v]</code>, where <code>u=sqrt(7), v=1/u</code>, and <code>[]=floor</code>.
 * @author Georg Fischer
 */
public class A190207 implements Sequence {
  private long mN = 0;
  private static final CR U = CR.valueOf(7).sqrt();
