...
/**
 * A190210 <code>a(n) = [n*u + n*v] - [n*u] - [n*v]</code>, where <code>u=sqrt(8), v=1/u</code>, and <code>[]=floor</code>.
 * @author Georg Fischer
 */
public class A190210 implements Sequence {
  private long mN = 0;
  private static final CR U = CR.valueOf(8).sqrt();
