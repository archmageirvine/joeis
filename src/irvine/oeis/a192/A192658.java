...
public class A192658 extends LambdaSequence {
  ...
  public A192658() {
    super(0, n -> Integers.SINGLETON.sum(0, n, k -> Binomial.binomial(n, k).multiply(Functions.SQRT.z(Binomial.binomial(2L * k, k))).multiply(Functions.SQRT.z(Binomial.binomial(2L * n - 2L * k, n - k)))));
  }
}
