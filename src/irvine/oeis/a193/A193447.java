...
public class A193447 extends A060822 {
  ...
  public A193447() {
    super(4, (n, p) -> MemoryFactorial.SINGLETON.factorial(Z.valueOf(p).subtract(Z.TWO)).add(Z.valueOf(p)).subtract(Z.ONE).divide(Z.valueOf(p).multiply(Z.valueOf(p).subtract(Z.ONE))));
  }
}
