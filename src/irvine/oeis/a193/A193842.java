...
/**
 * A193842 Triangular array: the fission of the polynomial sequence <code>((x+1)^n: n &gt;= 0)</code> by the polynomial sequence <code>((x+2)^n: n &gt;= 0)</code>. (Fission is defined at <code>Comments.)</code>.
