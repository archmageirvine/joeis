...
public class A200313 extends Sequence0 {
  ...
  public Z next() {
    ++mN;
    return Z.valueOf((long) mMult * mN + 1).pow(mN - 1).multiply(Functions.FACTORIAL.z(mMult * mN))
      .divide(Functions.FACTORIAL.z(mN).multiply(Functions.FACTORIAL.z(mMult).pow(mN)));
  }
}
