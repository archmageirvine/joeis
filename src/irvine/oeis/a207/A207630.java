 ...
 * (a,b,c,d,e,f) = (1, 1, 0,x+1, 1, 1)
 * @author Georg Fischer
 */
public class A207630 extends A208509 {

  /** Construct the sequence. */
  public A207630() {
    super(1, Polynomial.create(1), Polynomial.create(1), Polynomial.create(0), Polynomial.create(1, 1), Polynomial.create(1), Polynomial.create(1));
  }
}
