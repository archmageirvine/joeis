...
/**
 * A210019 In base 8, numbers n which have 8 distinct digits, do not start with 0, and have property that the product (written in base 8) of <code>any</code> two adjacent digits is a substring of n.
