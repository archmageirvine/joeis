...
/**
 * A210020 In base 9, numbers n which have 9 distinct digits, do not start with 0, and have property that the product (written in base <code>9)</code> of any two adjacent digits is a substring of <code>n</code>.
