...
/**
 * A214568 Triangle read by rows: T(n,k) is the number of rooted trees t with n vertices yielding k distinct rooted trees with <code>n+1</code> vertices when a pendant edge is added to a vertex of t <code>(1 &lt;= k &lt;= n)</code>.
