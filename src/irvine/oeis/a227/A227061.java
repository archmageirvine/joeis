...
/**
 * A227061 <code>T(n,k)=Number</code> of <code>(n+k-1)X(n+k-1)</code> binary arrays with k <code>1s</code> in every row and column with rows and columns in lexicographically nondecreasing order.
