...
/**
 * A239574 Number of <code>non-equivalent (mod D_3)</code> ways to place 4 indistinguishable points on a triangular grid of side n so that no two of them are adjacent.
