...
/**
 * A239575 Number of non-equivalent <code>(mod</code> D_3) ways to place 5 indistinguishable points on a triangular grid of side n so that no two of them are adjacent.
