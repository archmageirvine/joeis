...
/**
 * A240445 Numbers of ways to place five indistinguishable points on an n X n square grid so that no four of them are vertices of a square of <code>any</code> orientation.
