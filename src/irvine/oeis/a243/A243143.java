...
/**
 * A243143 Number of inequivalent <code>(mod D_3)</code> ways to place 4 points on a triangular grid of side n so that they are not vertices of an equilateral triangle of any orientation.
