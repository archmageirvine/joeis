...
/**
 * A243209 Number of inequivalent <code>(mod</code> D_3) ways to place 4 points on a triangular grid of side n so that they are not vertices of an equilateral triangle with sides parallel to the grid.
