 ...
 */
public class A245059 extends LambdaSequence {

  /** Construct the sequence. */
  public A245059() {
    super(0, n -> (n == 0) ? Z.ONE : Integers.SINGLETON.sum(1, n, k -> Binomial.binomial(n - 1, k - 1).multiply(Functions.STIRLING2.z(n, k).multiply(Z.TWO.pow(n - k)))));
  }
}
