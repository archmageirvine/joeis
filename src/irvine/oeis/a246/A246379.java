 ...
 */
public class A246379 extends MultiTransformSequence {

  private static final DirectSequence A003961 = new A003961();

  /** Construct the sequence. */
  public A246379() {
    super(1, (self, n) -> Predicates.PRIME.is(n) ? A003961.a(self.a(Functions.PRIME_PI.i(n)).add(1)) : self.a(n - Functions.PRIME_PI.i(n) - 1).multiply(2), "1");
  }
}
