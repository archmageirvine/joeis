...
/**
 * A249517 Numbers n for which the digital sum <code>A007953(n)</code> and the digital product <code>A007954(n)</code> both contain the same distinct digits as the number <code>n</code>.
