...
/**
 * A253709 Integer squares c^2 that are equal to the sums of M (A253707) consecutive cubed integers equaling a squared integer, <code>b^3 + (b+1)^3 + ... +</code> (b+M-1)^3 = c^2, for a first term <code>b(n)</code> being an odd squared integer (A016754).
