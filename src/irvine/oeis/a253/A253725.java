...
/**
 * A253725 Integer squares c^2 that are equal to the sums of a number M(n) of consecutive cubed integers <code>b^3 + (b+1)^3 + ... +</code> (b+M-1)^3 = c^2, starting at <code>b(n)</code> (A002593) for M(n) being twice a squared integer (A001105).
