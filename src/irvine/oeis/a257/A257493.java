...
/**
 * A257493 Number A(n,k) of n X n nonnegative integer matrices with all row and column sums equal to k; square array A(n,k), <code>n &gt;= 0, k &gt;= 0,</code> read by antidiagonals.
