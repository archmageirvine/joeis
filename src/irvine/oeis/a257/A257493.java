...
/**
 * A257493 Number <code>A(n,k)</code> of n X n nonnegative integer matrices with all row and column sums equal to k; square array <code>A(n,k), n &gt;= 0, k &gt;= 0</code>, read by antidiagonals.
