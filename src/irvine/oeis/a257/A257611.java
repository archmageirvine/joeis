...
/**
 * A257611 Triangle read by rows: T(n,k) = t(n-k, k); t(n,m) = f(m)*t(n-1,m) + f(n)*t(n,m-1), where f(x) = 2*x + 3.
 * @author Georg Fischer
 */
public class A257611 extends ModifiedPascalTriangle {

  @Override
  protected Z factorF(final long n, final long k) {
    return Z.valueOf(2 * (n - k) + 3);
  }

  @Override
  protected Z factorG(final long n, final long k) {
    return Z.valueOf(2 * k + 3);
  }
