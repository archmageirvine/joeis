...
/**
 * A257620 Triangle read by rows: T(n,k) = t(n-k, k); t(n,m) = f(m)*t(n-1,m) + f(n)*t(n,m-1), where f(x) = 3*x + 3.
 * @author Georg Fischer
 */
public class A257620 extends ModifiedPascalTriangle {

  @Override
  protected Z factorF(final long n, final long k) {
    return Z.valueOf(3 * (n - k) + 3);
  }

  @Override
  protected Z factorG(final long n, final long k) {
    return Z.valueOf(3 * k + 3);
  }
