 ...
 */
public class A259584 extends FilterNumberSequence {
  ...
  public A259584() {
    super(1, 1, k -> {
      ...
      final CR r = CR.SQRT2;
      return r.multiply(s.multiply(k).floor()).floor().subtract(s.multiply(r.multiply(k).floor()).floor()).compareTo(Z.valueOf(-2)) == 0;
    });
  }
}
