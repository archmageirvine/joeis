...
/**
 * A259992 Irregular triangle read by rows: T(n,k) = number of Havender tableaux of height 2 with n columns and k empty squares <code>(n &gt;= 0, 0 &lt;=</code> k <code>&lt;= 2*n)</code>.
