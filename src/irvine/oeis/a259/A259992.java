...
/**
 * A259992 Irregular triangle read by rows: <code>T(n,k) =</code> number of Havender tableaux of height 2 with n columns and k empty squares <code>(n &gt;= 0, 0 &lt;= k &lt;= 2*n)</code>.
