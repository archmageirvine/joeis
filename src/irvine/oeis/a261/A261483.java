...
/**
 * A261483 Number of set partitions of <code>[n]</code> into exactly seven parts such that no part contains two elements with a circular distance less than three.
