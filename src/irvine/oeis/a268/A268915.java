...
/**
 * A268915 Numerators of the rational number triangle R(m, a) = - (m^2 - 6*m*a + a^2)/(12*m), m &gt;= 1, a = 1, ..., m.  This is a regularized Sum_{j &gt;= 0} (a + m*j) defined by analytic continuation of a generalized Hurwitz Zeta function.
