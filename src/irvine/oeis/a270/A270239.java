 ...
 * G.f.: <code>Product_{k&gt;=1} (1/(1-x^k)^binomial(k+5, 5))</code>
 * @author Georg Fischer
 */
public class A270239 extends GeneralizedEulerTransform {
  ...
  protected Z[] advanceF(final long k) {
    return new Z[]{irvine.math.z.Binomial.binomial(k + 5, 5)};
  }
