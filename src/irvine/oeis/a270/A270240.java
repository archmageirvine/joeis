 ...
 * G.f.: <code>Product_{k&gt;=1} (1/(1-x^k)^binomial(k+6, 6))</code>
 * @author Georg Fischer
 */
public class A270240 extends GeneralizedEulerTransform {
  ...
  protected Z[] advanceF(final long k) {
    return new Z[]{irvine.math.z.Binomial.binomial(k + 6, 6)};
  }
