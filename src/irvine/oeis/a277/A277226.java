...
/**
 * A277226 Number of inequivalent <code>(modulo C_4</code> rotations) square <code>n X n</code> grids with squares coming in two colors and four squares have one of the colors.
