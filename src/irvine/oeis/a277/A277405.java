...
public class A277405 extends LambdaSequence {
  ...
  public A277405() {
    super(1, n -> Integers.SINGLETON.sum(0, n - 1, k -> Functions.FACTORIAL.z(k).multiply(Functions.FACTORIAL.z(n - k)).multiply(Integers.SINGLETON.sum(0, n - k + 1, i -> (((n - i + 1 & 1) == 0) ? Z.ONE : Z.NEG_ONE).multiply(Functions.STIRLING2.z(i, n - k + 1)).multiply(Functions.STIRLING1.z(n + 1, i))))));
  }
}
