...
/**
 * A278742 Lexicographically least strictly increasing sequence such that, for any <code>n&gt;0,</code> Sum_{k=1..n} <code>a(k)</code> can be computed without carries in base 10.
