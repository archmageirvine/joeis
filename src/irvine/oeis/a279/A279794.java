 ...
 */
public class A279794 extends LambdaSequence {

  private static final DirectSequence A010051 = new A010051();

  /** Construct the sequence. */
  public A279794() {
    super(1, n -> Integers.SINGLETON.sum(3, n - 1, i -> A010051.a(i).multiply(A010051.a(2 * n - i)).multiply(1 - Integer.signum(n / (2 * (n - i))))));
  }
}
