...
/**
 * A283115 Number of nonequivalent ways <code>(mod</code> D_3) to place 4 points on <code>an n</code> X n X n triangular grid so that no two of them are on the same row, column or diagonal.
