...
/**
 * A283116 Number of nonequivalent ways <code>(mod D_3)</code> to place 5 points on an <code>n X n X n</code> triangular grid so that no two of them are on the same row, column or diagonal.
