...
/**
 * A283116 Number of nonequivalent ways <code>(mod</code> D_3) to place 5 points on an n X n X n triangular grid so that no two of them are on the same row, column or diagonal.
