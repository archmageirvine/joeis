...
public class A289149 extends AbstractSequence {
  ...
  public A289149() {
    ...
    mSeq4 = new RootSequence(OFFSET, new A000521().skip(1), 4, 1);
    mSeq5 = new RootSequence(OFFSET, new A000521().skip(1), 5, 1);
    mSeq6 = new RootSequence(OFFSET, new A000521().skip(1), 6, 1);
    mN = OFFSET - 1;
  }
