...
/**
 * A289226 Number of ways to select 5 disjoint point triples from <code>an n</code> X n X n triangular point grid, each point triple forming <code>a 2</code> X 2 X 2 triangle.
