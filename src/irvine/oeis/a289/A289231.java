...
/**
 * A289231 Number of nonequivalent ways to select 4 disjoint point triples from an n X n X n triangular point grid, each point triple forming <code>a 2</code> X 2 X 2 triangle.
