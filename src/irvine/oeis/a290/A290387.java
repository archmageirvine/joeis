...
/**
 * A290387 Increasing sequence where <code>a(n)</code> is the smallest integer not yet in the sequence with no digits shared with the term <code>a(n-2)</code>, no repeated digits, and no 0-digit allowed.
