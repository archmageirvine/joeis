...
public class A293459 extends LambdaSequence {
  ...
  public A293459() {
    super(1, n -> new Q(Integers.SINGLETON.sum(0, n, k -> MemoryFactorial.SINGLETON.factorial(k)), Integers.SINGLETON.sum(0, n, k -> MemoryFactorial.SINGLETON.factorial(Binomial.binomial(n, k).intValueExact()))).den());
  }
}
