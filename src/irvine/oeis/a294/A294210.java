...
/**
 * A294210 Sum of the larger parts in the partitions of n into two squarefree parts or two nonsquarefree parts.
...
public class A294210 extends LambdaSequence {
  ...
  public A294210() {
    super(1, n -> Integers.SINGLETON.sum(1, n / 2, i -> Z.valueOf((n - i) * (eval1(i) == eval1(n - i) ? 1 : 0))));
  }
}
