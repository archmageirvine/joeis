 ...
 */
public class A296083 extends AbstractSequence {

  private int mN = 0;
  private final AbstractSequence mSeq1 = new A039653().skip(2);
  private final AbstractSequence mSeq2 = new A032741().skip(2);
