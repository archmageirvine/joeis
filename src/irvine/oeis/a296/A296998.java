...
/**
 * A296998 Number of ways to place 4 points on <code>an n</code> X n point grid so that no point is equally distant from two other points on the same row or the same column.
