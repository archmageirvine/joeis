...
/**
 * A296998 Number of ways to place 4 points on an <code>n X n</code> point grid so that no point is equally distant from two other points on the same row or the same column.
