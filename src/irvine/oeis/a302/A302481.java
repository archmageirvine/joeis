...
public class A302481 extends LambdaSequence {
  ...
  public A302481() {
    super(1, n -> Integers.SINGLETON.sum(1, n / 2, i -> Z.ONE.subtract(Puma.primePiZ(n - i).subtract(Puma.primePiZ(n - i - 1))).multiply(Puma.primePiZ(i).subtract(Puma.primePiZ(i - 1)))));
  }
}
