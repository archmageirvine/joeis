...
public class A302900 extends ExponentialGeneratingFunction {
  ...
  public Polynomial<Q> compute(final int n) {
    return RING.series(RING.add(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.add(RING.add(RING.add(RING.add(RING.multiply(RING.monomial(new Q(5040), 0), RING.pow(RING.cos(RING.x(), n), 4, n), n), RING.multiply(RING.add(RING.add(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.monomial(Q.SEVEN, 6), RING.multiply(RING.monomial(new Q(84), 0), RING.pow(RING.x(), 5, n), n)), RING.monomial(new Q(630), 4)), RING.monomial(new Q(3360), 3)), RING.monomial(new Q(12600), 2)), RING.monomial(new Q(30240), 1)), RING.multiply(RING.monomial(new Q(5040), 0), RING.sin(RING.x(), n), n)), RING.monomial(new Q(15120), 0)), RING.pow(RING.cos(RING.x(), n), 3, n), n)), RING.multiply(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.add(RING.multiply(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.pow(RING.x(), 7, n), RING.monomial(new Q(14), 6)), RING.monomial(new Q(126), 5)), RING.monomial(new Q(840), 4)), RING.monomial(new Q(4200), 3)), RING.monomial(new Q(15120), 2)), RING.monomial(new Q(35280), 1)), RING.monomial(new Q(20160), 0)), RING.sin(RING.x(), n), n), RING.monomial(new Q(60), 7)), RING.monomial(new Q(840), 6)), RING.monomial(new Q(5544), 5)), RING.monomial(new Q(23520), 4)), RING.monomial(new Q(67200), 3)), RING.monomial(new Q(120960), 2)), RING.monomial(new Q(105840), 1)), RING.monomial(new Q(40320), 0)), RING.pow(RING.cos(RING.x(), n), 2, n), n)), RING.multiply(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.multiply(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.zero(), RING.monomial(new Q(196), 6)), RING.monomial(new Q(2352), 5)), RING.monomial(new Q(12600), 4)), RING.monomial(new Q(40320), 3)), RING.monomial(new Q(75600), 2)), RING.monomial(new Q(60480), 1)), RING.monomial(new Q(20160), 0)), RING.sin(RING.x(), n), n), RING.monomial(new Q(434), 6)), RING.monomial(new Q(5208), 5)), RING.monomial(new Q(25200), 4)), RING.monomial(new Q(60480), 3)), RING.monomial(new Q(75600), 2)), RING.monomial(new Q(60480), 1)), RING.monomial(new Q(20160), 0)), RING.cos(RING.x(), n), n)), RING.multiply(RING.add(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.add(RING.subtract(RING.zero(), RING.monomial(new Q(298), 7)), RING.monomial(new Q(4172), 6)), RING.monomial(new Q(25200), 5)), RING.monomial(new Q(85680), 4)), RING.monomial(new Q(176400), 3)), RING.monomial(new Q(211680), 2)), RING.monomial(new Q(141120), 1)), RING.monomial(new Q(40320), 0)), RING.sin(RING.x(), n), n)), RING.monomial(new Q(332), 7)), RING.monomial(new Q(4648), 6)), RING.monomial(new Q(27720), 5)), RING.monomial(new Q(90720), 4)), RING.monomial(new Q(176400), 3)), RING.monomial(new Q(211680), 2)), RING.monomial(new Q(141120), 1)), RING.monomial(new Q(40320), 0)), RING.add(RING.subtract(RING.add(RING.multiply(RING.monomial(new Q(5040), 0), RING.pow(RING.cos(RING.x(), n), 4, n), n), RING.multiply(RING.subtract(RING.multiply(RING.monomial(new Q(20160), 0), RING.sin(RING.x(), n), n), RING.monomial(new Q(40320), 0)), RING.pow(RING.cos(RING.x(), n), 2, n), n)), RING.multiply(RING.monomial(new Q(40320), 0), RING.sin(RING.x(), n), n)), RING.monomial(new Q(40320), 0)), n);
  }
}
