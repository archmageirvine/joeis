...
public class A305276 extends LambdaSequence {
  ...
  public A305276() {
    super(0, n -> Integers.SINGLETON.sum(0, n, k -> Binomial.binomial(n - 1, k - 1).multiply(Z.valueOf(k).pow(k)).multiply(MemoryFactorial.SINGLETON.factorial(n)).divide(MemoryFactorial.SINGLETON.factorial(k))));
  }
}
