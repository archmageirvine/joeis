...
/**
 * A306788 Numbers n such that all digits in n are different and for each digit d it is true that <code>n =</code> d <code>(mod</code> sum of <code>digits(n) -</code> d).
