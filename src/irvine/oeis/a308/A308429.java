...
public class A308429 extends LambdaSequence {
  ...
  public A308429() {
    super(1, n -> Integers.SINGLETON.sum(1, n / 3, k -> Integers.SINGLETON.sum(k, ((n - k) / 2), i -> Z.valueOf(i).multiply(Z.ONE.subtract(Z.valueOf(Mobius.mobius(i)).square())).multiply(Z.ONE.subtract(Z.valueOf(Mobius.mobius(k)).square())).multiply(Z.ONE.subtract(Z.valueOf(Mobius.mobius(n - i - k)).square())).multiply(Z.valueOf(i + k).divide(Z.valueOf(n - i - k + 1)).signum()))));
  }
}
