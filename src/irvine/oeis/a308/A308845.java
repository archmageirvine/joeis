...
public class A308845 extends LambdaSequence {
  ...
  public A308845() {
    super(0, n -> Integers.SINGLETON.sum(1, n / 5, l -> Integers.SINGLETON.sum(l, (n - l) / 4, k -> Integers.SINGLETON.sum(k, (n - k - l) / 3, j -> Integers.SINGLETON.sum(j, (n - j - k - l) / 2, i -> Z.valueOf(n - i - j - k - l).multiply(Z.valueOf(Functions.MOBIUS.i((long) l)).square()).multiply(Z.valueOf(Functions.MOBIUS.i((long) k)).square()).multiply(Z.valueOf(Functions.MOBIUS.i((long) j)).square()).multiply(Z.valueOf(Functions.MOBIUS.i((long) i)).square()).multiply(Z.valueOf(Functions.MOBIUS.i((long) (n - i - j - k - l))).square()))))));
  }
}
