 ...
 */
public class A322084 extends LambdaArray {

  /** Construct the sequence. */
  public A322084() {
    super(1, 1, 1, -1, (n, k) -> Integers.SINGLETON.sumdiv(n, d -> (n / d) % 4 == 1 ? Z.valueOf(d).pow(k - 1) : Z.ZERO).subtract(Integers.SINGLETON.sumdiv(n, d -> (n / d) % 4 == 3 ? Z.valueOf(d).pow(k - 1) : Z.ZERO)));
  }
}
