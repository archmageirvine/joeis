 ...
 */
public class A325343 extends MultiTransformSequence {

  /** Construct the sequence. */
  public A325343() {
    super(1, (self, n) -> Functions.PARTITIONS.z(n).subtract(self.s(0)).subtract(self.s(1)), "1", new A003106(), new A064173());
  }
}
