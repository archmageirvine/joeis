...
public class A326450 extends LambdaSequence {
  ...
  public A326450() {
    super(0, n -> Integers.SINGLETON.sum(1, n / 8, p -> Integers.SINGLETON.sum(p, (n - p) / 7, o -> Integers.SINGLETON.sum(o, (n - o - p) / 6, m -> Integers.SINGLETON.sum(m, (n - m - o - p) / 5, l -> Integers.SINGLETON.sum(l, (n - l - m - o - p) / 4, k -> Integers.SINGLETON.sum(k, (n - k - l - m - o - p) / 3, j -> Integers.SINGLETON.sum(j, (n - j - k - l - m - o - p) / 2, i -> Z.valueOf(j).multiply(Z.valueOf(Functions.MOBIUS.i(p)).square()).multiply(Z.valueOf(Functions.MOBIUS.i(o)).square()).multiply(Z.valueOf(Functions.MOBIUS.i(m)).square()).multiply(Z.valueOf(Functions.MOBIUS.i(l)).square()).multiply(Z.valueOf(Functions.MOBIUS.i(k)).square()).multiply(Z.valueOf(Functions.MOBIUS.i(j)).square()).multiply(Z.valueOf(Functions.MOBIUS.i(i)).square()).multiply(Z.valueOf(Functions.MOBIUS.i(n - i - j - k - l - m - o - p)).square())))))))));
  }
}
