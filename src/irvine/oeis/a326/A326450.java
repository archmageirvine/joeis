...
public class A326450 extends LambdaSequence {
  ...
  public A326450() {
    super(0, n -> Integers.SINGLETON.sum(1, n / 8, p -> Integers.SINGLETON.sum(p, (n - p) / 7, o -> Integers.SINGLETON.sum(o, (n - o - p) / 6, m -> Integers.SINGLETON.sum(m, (n - m - o - p) / 5, l -> Integers.SINGLETON.sum(l, (n - l - m - o - p) / 4, k -> Integers.SINGLETON.sum(k, (n - k - l - m - o - p) / 3, j -> Integers.SINGLETON.sum(j, (n - j - k - l - m - o - p) / 2, i -> Z.valueOf(j).multiply(Z.valueOf(Functions.MOBIUS.i((long) p)).square()).multiply(Z.valueOf(Functions.MOBIUS.i((long) o)).square()).multiply(Z.valueOf(Functions.MOBIUS.i((long) m)).square()).multiply(Z.valueOf(Functions.MOBIUS.i((long) l)).square()).multiply(Z.valueOf(Functions.MOBIUS.i((long) k)).square()).multiply(Z.valueOf(Functions.MOBIUS.i((long) j)).square()).multiply(Z.valueOf(Functions.MOBIUS.i((long) i)).square()).multiply(Z.valueOf(Functions.MOBIUS.i((long) (n - i - j - k - l - m - o - p))).square())))))))));
  }
}
