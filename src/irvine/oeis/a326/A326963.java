...
public class A326963 extends LambdaSequence {
  ...
  public A326963() {
    super(0, n -> Integers.SINGLETON.sum(0, n, k -> MemoryFactorial.SINGLETON.factorial(k).multiply(Stirling.secondKind(n, k).add(Stirling.secondKind((n + 1) / 2, k))).divide(Z.TWO)));
  }
}
