...
public class A327091 extends LambdaSequence {
  ...
  public A327091() {
    super(1, n -> Integers.SINGLETON.sum(1, n, k -> MemoryFactorial.SINGLETON.factorial(k).multiply(Stirling.secondKind(n, k).subtract(Stirling.secondKind((n + 1) / 2, k))).divide(Z.TWO)));
  }
}
