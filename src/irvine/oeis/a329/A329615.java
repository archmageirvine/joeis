 ...
 */
public class A329615 extends LambdaSequence {

  private static final DirectSequence A108951 = new A108951();

  /** Construct the sequence. */
  public A329615() {
    super(1, n -> FactorUtils.iterate(A108951.a(n), Z.NEG_ONE, (x, p, e) -> x.equals(Z.NEG_ONE) ? Z.valueOf(e) : x.and(Z.valueOf(e))), 0);
  }
}
