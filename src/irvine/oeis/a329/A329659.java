...
public class A329659 extends FiniteSequence {
  ...
  public A329659() {
    super(new Z[]{new Z("115132219018763992565095597973971522401"), new Z("13384899942524140745922870"), new Z("18935132531699388"), new Z("2098649524599800996"), new Z("119564"),Z.ZERO, new Z("13598")});
  }
}
