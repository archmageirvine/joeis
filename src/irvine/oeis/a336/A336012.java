...
public class A336012 implements Sequence {
  ...
  public Z next() {
    ...
    return RING.multiply(RING.series(RING.one(), RING.subtract(RING.monomial(new Q(2), 0), RING.cosh(RING.x(), mN)), mN), RING.onePlusXToTheN(1), mN).coeff(mN).multiply(mF).toZ();
  }
}
