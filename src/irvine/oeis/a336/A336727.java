 ...
 */
public class A336727 extends UpperLeftTriangle {
  ...
  public Z matrixElement(final int n, final int k) {
    return n == 0 ? Z.ONE : Integers.SINGLETON.sum(1, n, j -> Z.valueOf(-k).pow(n - j).multiply(Binomial.binomial(n, j)).multiply(Binomial.binomial(n, j - 1))).divide(n);
  }
}
