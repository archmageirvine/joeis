 ...
 */
public class A341752 extends MultiTransformSequence {

  /** Construct the sequence. */
  public A341752() {
    super(2, (self, n) -> self.a(n - 1).pow(4).subtract(17).mod(Z.TWO.pow(n + 2)).isZero() ? self.a(n - 1) : self.a(n - 1).add(Z.TWO.pow(n - 1)), "3");
  }
}
