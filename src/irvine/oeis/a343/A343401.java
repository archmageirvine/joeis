...
public class A343401 extends LambdaSequence {
  ...
  public A343401() {
    super(1, n -> Integers.SINGLETON.sum(1, n / 3, j -> Integers.SINGLETON.sum(j, (n - j) / 2, i -> Z.valueOf((long) Integer.signum(3 - eval2(n, j) - eval2(n, i) - eval2(n, n - i - j)) * eval2(i, j) * eval2(n - i - j, i) * eval2(n - i - j, j)))));
  }
}
