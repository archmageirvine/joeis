...
public class A343710 implements Sequence {
  ...
  public Z next() {
    ...
    return RING.series(RING.exp(RING.x(), mN), RING.add(RING.one(), RING.multiply(RING.monomial(new Q(4), 0), RING.log(RING.oneMinusXToTheN(1), mN), mN)), mN).coeff(mN).multiply(mF).toZ();
  }
}
