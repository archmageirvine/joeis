 ...
 */
public class A344256 extends LambdaSequence {
  ...
  public A344256() {
    super(36, n -> Integers.SINGLETON.sum(1, n / 9, q -> Integers.SINGLETON.sum(q, (n - q) / 8, p -> Integers.SINGLETON.sum(p, (n - p - q) / 7, o -> Integers.SINGLETON.sum(o, (n - o - p - q) / 6, m -> Integers.SINGLETON.sum(m, (n - m - o - p - q) / 5, l -> Integers.SINGLETON.sum(l, (n - l - m - o - p - q) / 4, k -> Integers.SINGLETON.sum(k, (n - k - l - m - o - p - q) / 3, j -> Integers.SINGLETON.sum(j, (n - j - k - l - m - o - p - q) / 2, i -> Z.valueOf(eval1(q) == 2 && eval1(p) == 2 && eval1(o) == 2 && eval1(m) == 2 && eval1(l) == 2 && eval1(k) == 2 && eval1(j) == 2 && eval1(i) == 2 && eval1(n - i - j - k - l - m - o - p - q) == 2 ? 1 : 0))))))))));
  }
}
