...
public class A348535 extends LambdaSequence {
  ...
  public A348535() {
    super(1, n -> Integers.SINGLETON.sum(1, n / 3, j -> Integers.SINGLETON.sum(j, (n - j) / 2, i -> Z.valueOf((long) j * eval2(i * (n - i - j), j) + (long) i * eval2(j * (n - i - j), i) + (long) (n - i - j) * eval2(i * j, n - i - j)))));
  }
}
