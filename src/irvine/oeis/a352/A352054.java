...
import irvine.oeis.a321.A321812;
 ...
 */
public class A352054 extends TupleTransformSequence {

  /** Construct the sequence. */
  public A352054() {
    super(1, (n, s) -> s[0].multiply(s[1].pow(8)).subtract(s[2]), "", new A321812(), new A006519(), new A000035().skip(1));
  }
}
