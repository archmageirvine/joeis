...
import irvine.oeis.a321.A321814;
 ...
 */
public class A352056 extends TupleTransformSequence {

  /** Construct the sequence. */
  public A352056() {
    super(1, (n, s) -> s[0].multiply(s[1].pow(10)).subtract(s[2]), "", new A321814(), new A006519(), new A000035().skip(1));
  }
}
