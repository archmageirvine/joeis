...
public class A353225 extends LambdaSequence {
  ...
  public A353225() {
    super(0, n -> Rationals.SINGLETON.sum(0, n / 4, k -> new Q(Functions.STIRLING1.z(n - 3 * k, n - 4 * k).abs(), Functions.FACTORIAL.z(n - 3 * k)).multiply(Functions.FACTORIAL.z(n))).num());
  }
}
