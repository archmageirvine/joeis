  ...
  public A353894() {
    super(0, n -> {
      return Rationals.SINGLETON.sum(0, n / 4, k -> {
        return new Q(Functions.FACTORIAL.z(2 * k).multiply(Functions.STIRLING2.z(n - 2 * k, 2 * k)), Z.FOUR.pow(k).multiply(Functions.FACTORIAL.z(k).multiply(Functions.FACTORIAL.z(n - 2 * k))));
