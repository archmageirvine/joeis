...
public class A355373 extends LambdaSequence {
  ...
  public A355373() {
    super(0, n -> Integers.SINGLETON.sum(0, n, k -> MemoryFactorial.SINGLETON.factorial(k).multiply(Z.NEG_ONE.pow(k)).multiply(Z.valueOf(n).pow(n - k)).multiply(Stirling.secondKind(n, k))));
  }
}
