...
public class A355607 extends LambdaArray {
  ...
  public A355607() {
    super(0, 0, 0, -1, (n, k) -> Rationals.SINGLETON.sum(0, n / (k + 1), j -> new Q(Functions.STIRLING1.z(n - k * j, j)).divide(Functions.FACTORIAL.z(n - k * j))).multiply(Functions.FACTORIAL.z(n)).num());
  }
}
