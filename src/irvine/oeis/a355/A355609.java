...
public class A355609 extends LambdaArray {
  ...
  public A355609() {
    super(0, 0, 0, -1, (n, k) -> Rationals.SINGLETON.sum(0, n / (k + 1), j -> new Q(Functions.STIRLING1.z(n - k * j, j).abs()).divide(Functions.FACTORIAL.z(n - k * j))).multiply(Functions.FACTORIAL.z(n)).num());
  }
}
