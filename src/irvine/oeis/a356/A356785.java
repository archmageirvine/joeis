...
public class A356785 extends LambdaSequence {
  ...
  public A356785() {
    super(0, n -> Rationals.SINGLETON.sum(0, n / 2, k -> new Q(Z.valueOf(n + 1)).pow(k - 1).multiply(Functions.STIRLING2.z(n - k, k)).divide(Functions.FACTORIAL.z(n - k))).multiply(Functions.FACTORIAL.z(n)).num());
  }
}
