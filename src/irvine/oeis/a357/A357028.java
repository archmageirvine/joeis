...
public class A357028 extends LambdaSequence {
  ...
  public A357028() {
    super(0, n -> Rationals.SINGLETON.sum(0, n / 2, k -> new Q(n + 1).pow(k - 1).multiply(Functions.STIRLING1.z(n, 2L * k).abs()).multiply(Functions.FACTORIAL.z(2 * k)).divide(Functions.FACTORIAL.z(k))).num());
  }
}
