...
public class A357883 extends LambdaArray {
  ...
  public A357883() {
    super(0, 0, 0, -1, (n, k) -> Rationals.SINGLETON.sum(0, n, j -> new Q(Functions.FACTORIAL.z(k * j)).multiply(Functions.STIRLING1.z(n, k * j).abs()).divide(Functions.FACTORIAL.z(k).pow(j).multiply(Functions.FACTORIAL.z(j)))).num());
  }
}
