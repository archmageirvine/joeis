 ...
 */
public class A361284 extends LambdaSequence {

  /** Construct the sequence. */
  public A361284() {
    super(1, n -> new Q(n).multiply(new Q(n - 1)).multiply(new Q(n - 2)).divide(new Q(384)).multiply(Q.SEVEN.pow(n - 3).subtract(Q.THREE.multiply(Q.FIVE.pow(n - 3))).add(Q.THREE.pow(n - 2)).subtract(Q.ONE)).num());
  }
}
