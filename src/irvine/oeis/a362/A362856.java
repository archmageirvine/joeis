 ...
 */
public class A362856 extends UpperLeftTriangle {
  ...
  public Z matrixElement(final int n, final int k) {
    return Integers.SINGLETON.sum(0, n, j -> Z.valueOf(-k).pow(n - j).multiply(Z.valueOf(j).pow(j)).multiply(Binomial.binomial(n, j)));
  }
}
