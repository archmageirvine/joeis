 ...
 */
public class A363327 extends LambdaSequence {
  ...
  public A363327() {
    super(1, n -> Integers.SINGLETON.sum(1, n / 9, q -> Integers.SINGLETON.sum(q, (n - q) / 8, p -> Integers.SINGLETON.sum(p, (n - p - q) / 7, o -> Integers.SINGLETON.sum(o, (n - o - p - q) / 6, m -> Integers.SINGLETON.sum(m, (n - m - o - p - q) / 5, l -> Integers.SINGLETON.sum(l, (n - l - m - o - p - q) / 4, k -> Integers.SINGLETON.sum(k, (n - k - l - m - o - p - q) / 3, j -> Integers.SINGLETON.sum(j, (n - j - k - l - m - o - p - q) / 2, i -> Z.valueOf(eval2(n, i) + eval2(n, j) + eval2(n, k) + eval2(n, l) + eval2(n, m) + eval2(n, o) + eval2(n, p) + eval2(n, q) + eval2(n, n - i - j - k - l - m - o - p - q)))))))))));
  }
}
