...
public class A363529 extends LambdaSequence {
  ...
  public A363529() {
    super(0, n -> Rationals.SINGLETON.sum(0, n, k -> new Q(4 * n - 4 * k + 1).pow(k - 1).multiply(Binomial.binomial(k, n - k)).divide(Functions.FACTORIAL.z(k)).multiply(Functions.FACTORIAL.z(n))).num());
  }
}
