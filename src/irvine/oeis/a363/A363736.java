...
public class A363736 extends LambdaSequence {
  ...
  public A363736() {
    super(1, n -> Rationals.SINGLETON.sumdiv(n, d -> new Q(Z.NEG_ONE.pow(d + 1), MemoryFactorial.SINGLETON.factorial(d - 1))).multiply(MemoryFactorial.SINGLETON.factorial(n - 1)).num());
  }
}
