...
public class A363747 extends DecimalExpansionSequence {
  ...
  public A363747() {
    super(1, CR.PI.pow(CR.THREE.divide(CR.TWO)).divide(CR.EIGHT.multiply(CR.PI.divide(CR.valueOf(16)).sin()).multiply(CR.NINE.divide(CR.valueOf(16)).gamma()).multiply(CR.valueOf(15).divide(CR.valueOf(16)).gamma())));
  }
}
