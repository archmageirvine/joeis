...
public class A365040 extends LambdaSequence {
  ...
  public A365040() {
    super(0, n -> new Q(Functions.FACTORIAL.z(n)).multiply(Rationals.SINGLETON.sum(0, n, k -> new Q(Z.valueOf(-3 * k + 1).pow(k - 1).multiply(Binomial.binomial(k, n - k)), Functions.FACTORIAL.z(k)))).num());
  }
}
