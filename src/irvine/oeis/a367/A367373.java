...
public class A367373 extends LambdaSequence {
  ...
  public A367373() {
    super(0, n -> Integers.SINGLETON.sum(0, n, k -> Z.NEG_ONE.pow(n - k).multiply(Integers.SINGLETON.product(0, k - 1, j -> Z.valueOf(4 * j + 3))).multiply(Functions.STIRLING2.z(n, k))));
  }
}
