...
public class A367531 extends LambdaSequence {
  ...
  public A367531() {
    super(1, n -> {
      ...
      return (n <= 3) ? Z.valueOf(new int[]{0, 1, 6, 136}[n.intValue()]) : ((n & 1) == 0 ? Z.TWO.pow(n2 * n2 - 2).multiply(Z.TWO.pow(n2 * n2).add(Z.EIGHT.pow(n2 * n2).add(2))) : Z.TWO.pow(2L * n2 * n2 - 4L * n2 - 1).multiply(Z.FOUR.pow(n2).add(Z.FOUR.pow(n2 * n2))));
    });
  }
}
