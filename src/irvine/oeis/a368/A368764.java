...
public class A368764 extends LambdaSequence {
  ...
  public A368764() {
    super(0, n -> Rationals.SINGLETON.sum(0, n, k -> new Q(Binomial.binomial(k + 3, 4), MemoryFactorial.SINGLETON.factorial(k))).add(Q.ONE).multiply(MemoryFactorial.SINGLETON.factorial(n)).num());
  }
}
