...
public class A372250 extends LambdaSequence {
  ...
  public A372250() {
    super(0, n -> new Q(Functions.FACTORIAL.z(n)).multiply(Rationals.SINGLETON.sum(0, n / 3, k -> new Q(n - k + 1).pow(n - 2 * k - 1).divide(new Q(Functions.FACTORIAL.z(k)).multiply(Functions.FACTORIAL.z(n - 3 * k))))).num());
  }
}
