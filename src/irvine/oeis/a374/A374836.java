...
public class A374836 extends LambdaSequence {
  ...
  public A374836() {
    super(0, n -> Rationals.SINGLETON.sum(0, n - 2, k -> new Q(Z.NEG_ONE.pow(k).multiply(k + 1).multiply(k + 2).multiply(k + 3), Z.valueOf(2 * (2L * n - 1 - k))).multiply(Binomial.binomial(3L * n - 4 - 2L * k, n - 2 - k))).num());
  }
}
