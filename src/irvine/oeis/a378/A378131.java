...
public class A378131 extends DecimalExpansionSequence {
  ...
  public A378131() {
    super(1, CR.ONE.add(CR.THREE.sqrt()).multiply(CR.PI).sqrt().divide(CR.TWO.pow(CR.THREE.divide(CR.FOUR)).multiply(CR.THREE.pow(CR.ONE.divide(CR.EIGHT))).multiply(CrFunctions.GAMMA.cr(CR.THREE.divide(CR.FOUR)).square())));
  }
}
