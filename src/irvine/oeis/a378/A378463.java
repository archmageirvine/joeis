 ...
 */
public class A378463 extends LambdaSequence {

  /** Construct the sequence. */
  public A378463() {
    super(0, n -> Integers.SINGLETON.sum(0, n / 3, k -> Binomial.binomial(n + k - 1, k).multiply(Binomial.binomial(2L * n - k - 1, n - 3L * k))));
  }
}
