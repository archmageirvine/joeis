...
public class A379082 extends LambdaSequence {
  ...
  public A379082() {
    super(0, n -> new Q(2).multiply(Rationals.SINGLETON.sum(0, n / 3, k -> new Q(Binomial.binomial(2 * n + k + 2, k)).multiply(Binomial.binomial(2 * n + k + 2, n - 3 * k)).divide(2 * n + k + 2))).num());
  }
}
