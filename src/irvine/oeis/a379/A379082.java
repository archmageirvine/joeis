...
public class A379082 extends LambdaSequence {
  ...
  public A379082() {
    super(0, n -> Q.TWO.multiply(Rationals.SINGLETON.sum(0, n / 3, k -> new Q(Binomial.binomial(2L * n + k + 2, k)).multiply(Binomial.binomial(2L * n + k + 2, n - 3L * k)).divide(2L * n + k + 2))).num());
  }
}
