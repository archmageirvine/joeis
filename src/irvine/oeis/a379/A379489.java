 ...
 */
public class A379489 extends LambdaSequence {

  private static final DirectSequence A003961 = new A003961();

  /** Construct the sequence. */
  public A379489() {
    super(1, n -> Functions.GCD.z(n, A003961.a(n)).multiply(Functions.GCD.z(Functions.SIGMA1.z(n), Functions.PRIMORIAL_BASE_EXP.z(n))).subtract(Functions.GCD.z(n, Functions.PRIMORIAL_BASE_EXP.z(n)).multiply(Functions.GCD.z(Functions.SIGMA1.z(n), A003961.a(n)))));
  }
}
