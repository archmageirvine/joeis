...
public class A379690 extends LambdaSequence {
  ...
  public A379690() {
    super(0, n -> Rationals.SINGLETON.sum(0, n, k -> new Q(2 * n - 2 * k).pow(k).multiply(Functions.FACTORIAL.z(2 * n - k)).divide(new Q(Functions.FACTORIAL.z(k)).multiply(Functions.FACTORIAL.z(n - k)))).divide(n + 1).num());
  }
}
