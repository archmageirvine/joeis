 ...
 */
public class A380400 extends LambdaSequence {

  /** Construct the sequence. */
  public A380400() {
    super(1, n -> Integers.SINGLETON.sumdiv(n, d -> (Functions.GCD.i(d, n / d) == 1 && (d == 1 || Predicates.POWER.is(d)) ? Z.ONE : Z.ZERO).multiply(d)));
  }
}
