...
public class A380646 extends LambdaSequence {
  ...
  public A380646() {
    super(0, n -> Rationals.SINGLETON.sum(0, n, k -> new Q(2 * n + 2).pow(k - 1).multiply(Binomial.binomial(2 * n + 2, n - k)).divide(Functions.FACTORIAL.z(k))).multiply(Functions.FACTORIAL.z(n).multiply(2)).num());
  }
}
