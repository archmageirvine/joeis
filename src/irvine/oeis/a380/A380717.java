...
public class A380717 extends LambdaSequence {
  ...
  public A380717() {
    super(0, n -> Rationals.SINGLETON.sum(0, n, k -> new Q(n + k + 1).pow(k - 1).multiply(Binomial.binomial(2 * n - 2 * k, n - k)).divide(Functions.FACTORIAL.z(k))).multiply(Functions.FACTORIAL.z(n)).num());
  }
}
