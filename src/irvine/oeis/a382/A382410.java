 ...
 */
public class A382410 extends LambdaSequence {

  /** Construct the sequence. */
  public A382410() {
    super(0, n -> Functions.LUCAS.z(n).multiply(Functions.LUCAS.z(n).subtract(1)).multiply(Z.TWO.multiply(Functions.LUCAS.z(n)).subtract(1)));
  }
}
