 ...
 */
public class A382610 extends LambdaSequence {

  /** Construct the sequence. */
  public A382610() {
    super(0, n -> Functions.FIBONACCI.z(n).multiply(Functions.FIBONACCI.z(n).add(1)).multiply(Z.TWO.multiply(Functions.FIBONACCI.z(n)).add(1)));
  }
}
