 ...
 */
public class A383833 extends LambdaSequence {

  /** Construct the sequence. */
  public A383833() {
    super(0, n -> Functions.TRIANGULAR.z(n).multiply(Functions.TRIANGULAR.z(n).add(1)).multiply(Z.TWO.multiply(Functions.TRIANGULAR.z(n)).add(1)));
  }
}
