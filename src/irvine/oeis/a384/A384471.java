...
public class A384471 extends LambdaSequence {
  ...
  public A384471() {
    super(0, n -> Integers.SINGLETON.sum(0, n, k -> Binomial.binomial(n, k).square().multiply(Functions.STIRLING2.z(2L * k, k)).multiply(Functions.STIRLING2.z(2L * n - 2L * k, n - k))));
  }
}
