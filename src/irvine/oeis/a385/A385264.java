...
public class A385264 extends DecimalExpansionSequence {
  ...
  public A385264() {
    super(2, CR.valueOf(45).add(CR.valueOf(17).multiply(A002163.getCR())).add(CR.FIVE.multiply(CR.TWO.multiply(CR.valueOf(650).add(CR.valueOf(290).multiply(A002163.getCR())).sqrt().subtract(A002163.getCR()).subtract(CR.ONE)).sqrt())).divide(CR.SIX));
  }
}
