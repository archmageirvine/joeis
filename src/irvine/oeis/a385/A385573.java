...
/**
 * A385573 Decreasing partition array based on the sequence (sin(n)); see Comments.
 * @author Sean A. Irvine
 */
public class A385573 extends Sequence1 {
  ...
  protected A385573(final Function<Long, CR> f) {
    mLambda = f;
  }
