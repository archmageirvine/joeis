...
public class A386507 extends MultiTransformSequence {
  ...
  public A386507() {
    super(0, (self, n) -> self.a(n - 1).add(Integers.SINGLETON.sum(0, n - 1, k -> Z.valueOf(1 + k).multiply(Z.valueOf(k).pow(4)).multiply(Binomial.binomial(n - 1, k)).multiply(self.a(k)).multiply(self.a(n - 1 - k)))), "1");
  }
}
