...
public class A386675 extends Sequence0 {
  ...
  private Q t(final int n, final int k) {
    return Rationals.SINGLETON.sum(0, n, j -> LaguerrePolynomials.p(0, j, Q.ONE).multiply(Functions.STIRLING1.z(j, k).multiply(Z.NEG_ONE.pow(j))).divide(Functions.FACTORIAL.z(j)));
  }
