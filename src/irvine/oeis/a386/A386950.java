...
/**
 * A386950 A sequence constructed by greedily sampling the pdf (H(10)-H(i))/10, where H(i) is the i-th Harmonic number and the support is [0,9], to minimize discrepancy.
