...
/**
 * A388676 Decimal expansion of (1/1250) * exp(Pi / 4) * sqrt(Pi) * 2^(9/10) * Gamma(9/10)^2 * Gamma(7/10)^2 * (1/4*5^(1/2)-1/4)^2 * (1/4*5^(1/2)+1/4)^2*5^(1/2) * (5^(1/2) * sqrt(2) * (5+5^(1/2))^(1/2))^(7/2) * 4^(1/2) / (sqrt(2) * (5+5^(1/2))^(1/2))^(1/2) / Gamma(3/4)^2 / Gamma(4/5)^4.
