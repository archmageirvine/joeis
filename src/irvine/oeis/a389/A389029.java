...
/**
 * A389029 Decimal expansion of (1024/3) * exp(Pi) * Pi^(5/3) * 3^(23/24) * Gamma(11/12)^(47/6) / Gamma(2/3)^(7/3) / Gamma(3/4)^(46/3) / (sqrt(2) * (1+3^(1/2)))^(47/6) / (sqrt(2) * (3^(1/2)-1))^(11/2) * Gamma(7/12)^(11/2).
