...
/**
 * A389762 Irregular triangle read by rows: T(n,k) is the number of composite numbers in the k-th 2-dense sublist of divisors of n, with n &gt;= 1, k &gt;= 1.
 * @author Sean A. Irvine
 */
public class A389762 extends Sequence1 {
