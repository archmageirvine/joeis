...
public class A392483 extends Sequence1 {
  ...
  public Z next() {
    ...
    return Integers.SINGLETON.sum(1, mN, i -> Integers.SINGLETON.sum(1, mN, j -> Z.NEG_ONE.pow(i + j).multiply(Binomial.binomial(mN, j)).multiply(Binomial.binomial((mN - i) * (mN - j), mM))).multiply(Binomial.binomial(mN, i)));
  }
}
