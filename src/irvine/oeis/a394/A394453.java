...
/**
 * A394453 a(n) = number of iterations of f(n) = sigma(n) if sigma(n) &lt; 2n (n deficient), else n / lpf(n) (where lpf(n) is the least prime factor), needed to reach a cycle, for n &gt;= 2.
