...
/**
 * A394854 Sequence where k is appended after every F(k+1) occurrences of 1, where F is the Fibonacci sequence (A000045), with multiple values following a 1 listed in order.
