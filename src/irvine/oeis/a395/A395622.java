...
/**
 * A395622 Nonsquare integers c &gt; 0 for which there are positive nonsquare integers a &lt; b &lt; c such that sqrt(a) + sqrt(b) + sqrt(c) is closer to an integer than for all smaller nonsquare c &gt; b &gt; a &gt; 0.
