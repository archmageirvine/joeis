...
/**
 * A397418 Lexicographically earliest infinite sequence of distinct positive powerful numbers such that gcd(a(n), a(n-1)) &gt; 1 for n &gt;= 2.
 * @author Sean A. Irvine
 */
public class A397418 extends Sequence1 {
