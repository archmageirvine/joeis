...
/**
 * A399251 Rectangular array read by descending antidiagonals: c(n, k) = 1 if floor(k*x^n) = floor(m*x) for some positive integer m, where x = 1+sqrt(5), and c(n, k) = 0 otherwise.
 * @author Sean A. Irvine
 */
public class A399251 extends Sequence1 {
