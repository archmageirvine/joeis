 ...
 * @author jmason
 */
class Square extends Element<Square> {

  Square(final int x, final int y, final int colour) {
    mCoords = new int[2];
    mCoords[0] = x;
    mCoords[1] = y;
    mColour = colour;
  ...
  boolean hasSide(final CoordSet2 cs2, final int dir) {
  ...
  boolean twoTouch(final CoordSet2 cs2) {
    int n = 0;
