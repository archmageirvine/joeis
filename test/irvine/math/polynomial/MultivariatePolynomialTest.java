...
public class MultivariatePolynomialTest extends TestCase {
  ...
  public void testConstruction0() {
    final MultivariatePolynomial p = new MultivariatePolynomial(5);
    assertTrue(p.isZero());
  ...
  public void testConstruction1() {
    final MultivariatePolynomial p = new MultivariatePolynomial(3, new int[][] {{1, 2, 3}}, Z.FOUR);
    assertFalse(p.isZero());
    assertEquals("4xy^2z^3", p.toString());
  }

  public void testConstruction2() {
    final MultivariatePolynomial p = new MultivariatePolynomial(3, new int[][] {{1, 2, 3}, {2, 0, 1}}, Z.FOUR, Z.NEG_ONE);
    assertFalse(p.isZero());
    assertEquals("4xy^2z^3-x^2z", p.toString());
  }

  public void testScalarMultiply() {
    final MultivariatePolynomial p = new MultivariatePolynomial(3, new int[][] {{2, 0, 1}, {1, 2, 3}}, Z.NEG_ONE, Z.FOUR);
    assertFalse(p.isZero());
    assertEquals("4xy^2z^3-x^2z", p.toString());
  ...
  public void testConstant() {
    final MultivariatePolynomial num = new MultivariatePolynomial(2, new int[][] {{0, 0}}, Z.ONE);
    assertEquals("1", num.toString());
  }

  public void testConstantN1() {
    final MultivariatePolynomial num = new MultivariatePolynomial(2, new int[][] {{0, 0}}, Z.NEG_ONE);
    assertEquals("-1", num.toString());
  ...
  public void testConstant2() {
    final MultivariatePolynomial num = new MultivariatePolynomial(2, new int[][] {{0, 0}}, Z.TWO);
    assertEquals("2", num.toString());
  }

  public void testConstruction1Var() {
    final MultivariatePolynomial p = new MultivariatePolynomial(1, new int[][] {{1}, {2}}, Z.FOUR, Z.NEG_ONE);
    assertEquals("4x-x^2", p.toString());
    assertEquals("4x-x^2", p.toPolynomial().toString());
  }

  public void testA010029() {
    final MultivariatePolynomial p = new MultivariatePolynomial(2, new int[][] {{2, 0}, {2, 1}, {1, 0}}, Z.ONE, Z.NEG_ONE, Z.NEG_ONE);
    assertEquals("-x+x^2-x^2y", p.toString());
    final MultivariatePolynomial p2 = p.multiply(p);
    assertEquals("x^2-2x^3+2x^3y+x^4-2x^4y+x^4y^2", p2.toString());
    final MultivariatePolynomial p3 = p2.multiply(p);
    assertEquals("-x^3+3x^4-3x^4y-3x^5+6x^5y-3x^5y^2+x^6-3x^6y+3x^6y^2-x^6y^3", p3.toString());
    final MultivariatePolynomial p3b = p2.multiply(p, new int[] {5, 1});
