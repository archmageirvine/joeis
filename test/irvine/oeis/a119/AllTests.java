...
public class AllTests extends TestSuite {
  ...
  public static Test suite() {
    ...
    suite.addTestSuite(A119309Test.class);
    ...
    suite.addTestSuite(A119358Test.class);
    suite.addTestSuite(A119363Test.class);
    ...
    suite.addTestSuite(A119401Test.class);
    ...
    suite.addTestSuite(A119515Test.class);
    ...
    suite.addTestSuite(A119590Test.class);
    ...
    suite.addTestSuite(A119806Test.class);
    suite.addTestSuite(A119807Test.class);
    suite.addTestSuite(A119826Test.class);
    suite.addTestSuite(A119827Test.class);
    suite.addTestSuite(A119852Test.class);
    suite.addTestSuite(A119865Test.class);
    suite.addTestSuite(A119886Test.class);
    suite.addTestSuite(A119900Test.class);
    suite.addTestSuite(A119910Test.class);
    suite.addTestSuite(A119915Test.class);
    suite.addTestSuite(A119916Test.class);
    suite.addTestSuite(A119967Test.class);
    suite.addTestSuite(A119975Test.class);
    suite.addTestSuite(A119976Test.class);
