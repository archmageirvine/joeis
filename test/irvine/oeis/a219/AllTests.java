...
public class AllTests extends TestSuite {
  ...
  public static Test suite() {
    ...
    suite.addTestSuite(A219022Test.class);
    ...
    suite.addTestSuite(A219233Test.class);
    ...
    suite.addTestSuite(A219312Test.class);
    suite.addTestSuite(A219314Test.class);
    ...
    suite.addTestSuite(A219534Test.class);
    suite.addTestSuite(A219535Test.class);
    suite.addTestSuite(A219536Test.class);
    suite.addTestSuite(A219537Test.class);
    suite.addTestSuite(A219538Test.class);
    suite.addTestSuite(A219562Test.class);
    ...
    suite.addTestSuite(A219673Test.class);
    ...
    suite.addTestSuite(A219705Test.class);
    ...
    suite.addTestSuite(A219753Test.class);
    ...
    suite.addTestSuite(A219837Test.class);
    suite.addTestSuite(A219846Test.class);
    suite.addTestSuite(A219853Test.class);
    suite.addTestSuite(A219863Test.class);
