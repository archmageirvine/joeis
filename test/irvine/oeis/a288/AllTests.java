...
public class AllTests extends TestSuite {
  ...
  public static Test suite() {
    ...
    suite.addTestSuite(A288143Test.class);
    suite.addTestSuite(A288149Test.class);
    suite.addTestSuite(A288150Test.class);
    suite.addTestSuite(A288151Test.class);
    ...
    suite.addTestSuite(A288311Test.class);
    ...
    suite.addTestSuite(A288356Test.class);
    ...
    suite.addTestSuite(A288470Test.class);
    suite.addTestSuite(A288476Test.class);
    suite.addTestSuite(A288477Test.class);
    suite.addTestSuite(A288478Test.class);
    suite.addTestSuite(A288482Test.class);
    suite.addTestSuite(A288483Test.class);
    suite.addTestSuite(A288484Test.class);
    ...
    suite.addTestSuite(A288550Test.class);
    ...
    suite.addTestSuite(A288691Test.class);
    suite.addTestSuite(A288692Test.class);
    ...
    suite.addTestSuite(A288719Test.class);
    ...
    suite.addTestSuite(A288823Test.class);
    suite.addTestSuite(A288824Test.class);
    ...
    suite.addTestSuite(A288918Test.class);
    suite.addTestSuite(A288919Test.class);
    suite.addTestSuite(A288920Test.class);
    suite.addTestSuite(A288925Test.class);
    suite.addTestSuite(A288936Test.class);
    suite.addTestSuite(A288947Test.class);
    suite.addTestSuite(A288953Test.class);
