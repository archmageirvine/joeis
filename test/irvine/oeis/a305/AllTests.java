...
public class AllTests extends TestSuite {
  ...
  public static Test suite() {
    ...
    suite.addTestSuite(A305031Test.class);
    suite.addTestSuite(A305032Test.class);
    ...
    suite.addTestSuite(A305067Test.class);
    ...
    suite.addTestSuite(A305167Test.class);
    ...
    suite.addTestSuite(A305500Test.class);
    suite.addTestSuite(A305539Test.class);
    suite.addTestSuite(A305548Test.class);
    suite.addTestSuite(A305549Test.class);
    suite.addTestSuite(A305554Test.class);
    suite.addTestSuite(A305555Test.class);
    suite.addTestSuite(A305561Test.class);
    suite.addTestSuite(A305607Test.class);
    suite.addTestSuite(A305608Test.class);
    suite.addTestSuite(A305609Test.class);
    suite.addTestSuite(A305612Test.class);
    suite.addTestSuite(A305623Test.class);
    suite.addTestSuite(A305650Test.class);
    suite.addTestSuite(A305668Test.class);
    suite.addTestSuite(A305693Test.class);
    ...
    suite.addTestSuite(A305730Test.class);
    ...
    suite.addTestSuite(A305753Test.class);
    ...
    suite.addTestSuite(A305886Test.class);
    suite.addTestSuite(A305889Test.class);
    suite.addTestSuite(A305991Test.class);
    return suite;
  }
