...
public class AllTests extends TestSuite {
  ...
  public static Test suite() {
    ...
    suite.addTestSuite(A309091Test.class);
    suite.addTestSuite(A309117Test.class);
    ...
    suite.addTestSuite(A309301Test.class);
    suite.addTestSuite(A309302Test.class);
    suite.addTestSuite(A309303Test.class);
    suite.addTestSuite(A309315Test.class);
    suite.addTestSuite(A309330Test.class);
    suite.addTestSuite(A309331Test.class);
    ...
    suite.addTestSuite(A309379Test.class);
    suite.addTestSuite(A309380Test.class);
    suite.addTestSuite(A309419Test.class);
    suite.addTestSuite(A309420Test.class);
    suite.addTestSuite(A309442Test.class);
    suite.addTestSuite(A309462Test.class);
    ...
    suite.addTestSuite(A309543Test.class);
    ...
    suite.addTestSuite(A309926Test.class);
    suite.addTestSuite(A309927Test.class);
    suite.addTestSuite(A309928Test.class);
    suite.addTestSuite(A309929Test.class);
